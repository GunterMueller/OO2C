...
void XML_UnicodeCodec__CodecDesc_EncodeBOM(XML_UnicodeCodec__Codec codec, OOC_CHAR8 dest[], OOC_LEN dest_0d, OOC_INT32 destStart, OOC_INT32 destEnd, OOC_INT32 *destDone) {
  ...
  i1 = i1==0;
  if (i1) goto l3;
  _copy_16((const void*)((OOC_CHAR16[]){65279,0}),(void*)(OOC_INT64)source,2);
  i1 = destEnd;
  i2 = destStart;
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 11863)))), XML_UnicodeCodec__CodecDesc_Encode)),XML_UnicodeCodec__CodecDesc_Encode)((XML_UnicodeCodec__Codec)i0, (void*)(OOC_INT64)source, 2, 0, 1, (void*)(OOC_INT64)dest, dest_0d, i2, i1, (void*)(OOC_INT64)&sourceDone, (void*)(OOC_INT64)destDone);
  i0 = sourceDone;
...
void XML_UnicodeCodec__Register(const OOC_CHAR8 name__ref[], OOC_LEN name_0d, XML_UnicodeCodec__Factory factory) {
  ...
  auto void XML_UnicodeCodec__Register_ScanList(XML_UnicodeCodec__Node *l);
    ...
    void XML_UnicodeCodec__Register_ScanList(XML_UnicodeCodec__Node *l) {
      ...
      i1 = i0==(OOC_INT64)0;
      if (i1) goto l7;
      i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 14721))+8);
      i1 = (
      _cmp8((const void*)(_check_pointer(i1, 14727)),(const void*)(OOC_INT64)name))==0;
      if (i1) goto l5;
      XML_UnicodeCodec__Register_ScanList((void*)(_check_pointer(i0, 14802)));
      goto l8;
l5:
      i1 = (OOC_INT64)factory;
      *(OOC_INT64*)((_check_pointer(i0, 14751))+16) = i1;
      goto l8;
l7:
      i0 = (OOC_INT64)RT0__NewObject(_td_XML_UnicodeCodec__Node.baseTypes[0]);
      *l = (XML_UnicodeCodec__Node)i0;
      i1 = Strings__Length((void*)(OOC_INT64)name, name_0d);
      *(OOC_INT64*)((_check_pointer(i0, 14588))+8) = ((OOC_INT64)RT0__NewObject(_td_XML_UnicodeCodec__3139.baseTypes[0], (i1+1)));
      i0 = (OOC_INT64)*l;
      i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 14643))+8);
      i2 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 14643))+8);
      i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 14649)), 0);
      _copy_8((const void*)(OOC_INT64)name,(void*)(_check_pointer(i1, 14649)),i2);
      i1 = (OOC_INT64)factory;
      *(OOC_INT64*)((_check_pointer(i0, 14662))+16) = i1;
      i0 = (OOC_INT64)*l;
      *(OOC_INT64*)(_check_pointer(i0, 14693)) = (OOC_INT64)0;
l8:
      return;
      ;
    }
  ...
  Strings__Capitalize((void*)(OOC_INT64)name, name_0d);
  XML_UnicodeCodec__Register_ScanList((void*)(OOC_INT64)&XML_UnicodeCodec__factoryList);
  return;
  ;
}
...
void XML_UnicodeCodec__Unregister(const OOC_CHAR8 name__ref[], OOC_LEN name_0d) {
  ...
  auto void XML_UnicodeCodec__Unregister_ScanList(XML_UnicodeCodec__Node *l);
    ...
    void XML_UnicodeCodec__Unregister_ScanList(XML_UnicodeCodec__Node *l) {
      ...
      i1 = i0!=(OOC_INT64)0;
      if (!i1) goto l7;
      i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 15234))+8);
      i1 = (
      _cmp8((const void*)(_check_pointer(i1, 15240)),(const void*)(OOC_INT64)name))==0;
      if (i1) goto l5;
      XML_UnicodeCodec__Unregister_ScanList((void*)(_check_pointer(i0, 15312)));
      goto l7;
l5:
      i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 15271));
      *l = (XML_UnicodeCodec__Node)i0;
l7:
      return;
      ;
  ...
  OOC_INITIALIZE_VPAR(name__ref,name,OOC_CHAR8 ,name_0d)
  Strings__Capitalize((void*)(OOC_INT64)name, name_0d);
  XML_UnicodeCodec__Unregister_ScanList((void*)(OOC_INT64)&XML_UnicodeCodec__factoryList);
  return;
  ;
}
...
XML_UnicodeCodec__Factory XML_UnicodeCodec__GetFactory(const OOC_CHAR8 name__ref[], OOC_LEN name_0d) {
  ...
  OOC_INITIALIZE_VPAR(name__ref,name,OOC_CHAR8 ,name_0d)
  Strings__Capitalize((void*)(OOC_INT64)name, name_0d);
  i0 = (OOC_INT64)XML_UnicodeCodec__factoryList;
  ...
  goto l5;
l3:
  i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 15745))+8);
  i1 = (
  _cmp8((const void*)(_check_pointer(i1, 15751)),(const void*)(OOC_INT64)name))!=0;
  
l5:
  if (!i1) goto l17;
l8_loop:
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 15776));
  n = (XML_UnicodeCodec__Node)i0;
  i1 = i0!=(OOC_INT64)0;
  if (i1) goto l11;
  i1=0u;
...
l17:
  i1 = i0!=(OOC_INT64)0;
  if (i1) goto l20;
  return (XML_UnicodeCodec__Factory)(OOC_INT64)0;
  goto l21;
l20:
  i0 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 15828))+16);
...
void OOC_XML_UnicodeCodec_init(void) {
  ...
  XML_UnicodeCodec__factoryList = (XML_UnicodeCodec__Node)(OOC_INT64)0;
  return;
  ;
}
