...
XML_Builder__Builder XML_Builder__New(void) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_XML_Builder__Builder.baseTypes[0]);
...
void XML_Builder__InitAttribute(XML_Builder__Attribute attr, XML_DTD__NamespaceDeclaration namespaceDecl, XML_UnicodeBuffer__CharArray localName, XML_DTD__AttrDecl attrDecl, XML_DTD__AttValue value, OOC_CHAR8 specified, XML_Locator__Locator locator) {
  ...
  i0 = (OOC_INT64)attr;
  i1 = (OOC_INT64)namespaceDecl;
  *(OOC_INT64*)(_check_pointer(i0, 15812)) = i1;
  i1 = (OOC_INT64)localName;
  *(OOC_INT64*)((_check_pointer(i0, 15854))+8) = i1;
  i1 = (OOC_INT64)attrDecl;
  *(OOC_INT64*)((_check_pointer(i0, 15888))+16) = i1;
  i1 = (OOC_INT64)value;
  *(OOC_INT64*)((_check_pointer(i0, 15920))+24) = i1;
  i1 = specified;
  *(OOC_UINT8*)((_check_pointer(i0, 15946))+32) = i1;
  i1 = (OOC_INT64)locator;
  _copy_block((_check_pointer(i1, 15996)),((_check_pointer(i0, 15980))+40),32);
  return;
  ;
}
...
XML_Builder__Attribute XML_Builder__NewAttribute(XML_DTD__NamespaceDeclaration namespaceDecl, XML_UnicodeBuffer__CharArray localName, XML_DTD__AttrDecl attrDecl, XML_DTD__AttValue value, OOC_CHAR8 specified, XML_Locator__Locator locator) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_XML_Builder__Attribute.baseTypes[0]);
  i1 = specified;
  i2 = !i1;
  if (!i2) goto l4;
  locator = (XML_Locator__Locator)(OOC_INT64)0;
l4:
  i2 = (OOC_INT64)namespaceDecl;
  i3 = (OOC_INT64)localName;
  i4 = (OOC_INT64)attrDecl;
  i5 = (OOC_INT64)value;
  i6 = (OOC_INT64)locator;
...
void XML_Builder__InitAttributeList(XML_Builder__AttributeList attrList) {
  ...
  *(OOC_INT64*)((_check_pointer(i0, 16859))+8) = ((OOC_INT64)RT0__NewObject(_td_XML_Builder__AttributeArray.baseTypes[0], 4));
...
XML_Builder__AttributeList XML_Builder__NewAttributeList(void) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_XML_Builder__AttributeList.baseTypes[0]);
...
void XML_Builder__AttributeListDesc_Clear(XML_Builder__AttributeList attrList) {
  ...
  i2=0;
l3_loop:
  i3 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 17329))+8);
  i3 = _check_pointer(i3, 17335);
  i4 = OOC_ARRAY_LENGTH(i3, 0);
  *(OOC_INT64*)(i3+(_check_index(i2, i4, OOC_UINT32, 17335))*8) = 0;
  i2 = i2+1;
  i = i2;
  i3 = i2<i1;
  if (i3) goto l3_loop;
...
void XML_Builder__AttributeListDesc_Append(XML_Builder__AttributeList attrList, XML_Builder__Attribute attr) {
  ...
  i0 = (OOC_INT64)attrList;
  i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 17603))+8);
  i2 = *(OOC_INT32*)(_check_pointer(i0, 17582));
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 17609)), 0);
  i1 = i2==i1;
  if (!i1) goto l11;
  i1 = *(OOC_INT32*)(_check_pointer(i0, 17642));
  i1 = (OOC_INT64)RT0__NewObject(_td_XML_Builder__AttributeArray.baseTypes[0], (i1*2));
...
l5_loop:
  ...
  i6 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 17717))+8);
  i6 = _check_pointer(i6, 17723);
  i7 = OOC_ARRAY_LENGTH(i6, 0);
  i6 = (OOC_INT64)*(OOC_INT64*)(i6+(_check_index(i3, i7, OOC_UINT32, 17723))*8);
  *(OOC_INT64*)(i4+(_check_index(i3, i5, OOC_UINT32, 17702))*8) = i6;
  i3 = i3+1;
  i = i3;
  i4 = i3<i2;
  if (i4) goto l5_loop;
l10:
  *(OOC_INT64*)((_check_pointer(i0, 17752))+8) = i1;
l11:
  i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 17787))+8);
  i1 = _check_pointer(i1, 17793);
  i2 = *(OOC_INT32*)(_check_pointer(i0, 17802));
  i3 = OOC_ARRAY_LENGTH(i1, 0);
  i4 = (OOC_INT64)attr;
  *(OOC_INT64*)(i1+(_check_index(i2, i3, OOC_UINT32, 17793))*8) = i4;
