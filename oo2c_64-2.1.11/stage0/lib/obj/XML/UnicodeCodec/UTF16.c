...
static XML_UnicodeCodec_UTF16__Codec XML_UnicodeCodec_UTF16__NewBE(OOC_INT8 bom) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_XML_UnicodeCodec_UTF16__Codec.baseTypes[0]);
  i1 = bom;
...
l11:
  i9=i7;i10=i8;
l12_loop:
  i11 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index((i9+i1), source_0d, OOC_UINT32, 2614)));
  i12 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index((i9+i2), source_0d, OOC_UINT32, 2642)));
  i11 = (i11*256)+i12;
  cval = i11;
  i12 = i11<55296;
  if (i12) goto l19;
...
l21:
  ...
  goto l27;
l25:
  i12 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(((i9+2)+i1), source_0d, OOC_UINT32, 2885)));
...
l27:
  ...
  goto l31;
l29:
  i12 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(((i9+2)+i1), source_0d, OOC_UINT32, 2906)));
...
l31:
  ...
  *(OOC_UINT16*)((OOC_INT64)dest+(_check_index(i10, dest_0d, OOC_UINT32, 3328))*2) = 65533u;
  i9 = i9+2;
  i = i9;
  i10 = i10+1;
  j = i10;
  ...
  goto l36;
l33:
  *(OOC_UINT16*)((OOC_INT64)dest+(_check_index(i10, dest_0d, OOC_UINT32, 3016))*2) = i11;
  i11 = i9+2;
  i12 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index((i11+i1), source_0d, OOC_UINT32, 3086)));
  i11 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index((i11+i2), source_0d, OOC_UINT32, 3146)));
  *(OOC_UINT16*)((OOC_INT64)dest+(_check_index((i10+1), dest_0d, OOC_UINT32, 3051))*2) = ((i12*256)+i11);
  i9 = i9+4;
  i = i9;
  i10 = i10+2;
  j = i10;
  ...
  goto l36;
l35:
  *(OOC_UINT16*)((OOC_INT64)dest+(_check_index(i10, dest_0d, OOC_UINT32, 2785))*2) = i11;
  i9 = i9+2;
  i = i9;
  i10 = i10+1;
  j = i10;
...
l48:
  ...
  goto l53;
l51:
  i6 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index((i2+i1), source_0d, OOC_UINT32, 3748)));
...
l53:
  ...
  goto l65;
l56_loop:
  i6 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index((i2+i1), source_0d, OOC_UINT32, 3815)));
  i6 = XML_UnicodeCodec_UTF16__CodecDesc_Decode_BytesPerEncoding(i6);
  i2 = i2+i6;
  i = i2;
  i6 = (i2+1)<i3;
...
l65:
  ...
  *destDone = i8;
  goto l69;
l68:
  XML_UnicodeCodec_UTF16__CodecDesc_Decode((XML_UnicodeCodec_UTF16__Codec)i0, (void*)(OOC_INT64)source, source_0d, i7, (i1+5), (void*)(OOC_INT64)dest, dest_0d, i4, (i5+1), (void*)(OOC_INT64)sourceDone, (void*)(OOC_INT64)destDone);
l69:
  i2 = *sourceDone;
  i1 = i2==i1;
  if (i1) goto l72;
...
l78:
  ...
  *(OOC_INT32*)(_check_pointer(i0, 4393)) = (i1+1);
  i0 = *destDone;
  *(OOC_UINT16*)((OOC_INT64)dest+(_check_index(i0, dest_0d, OOC_UINT32, 4422))*2) = 65533u;
  *destDone = (i0+1);
  *sourceDone = i3;
l81:
  return;
...
l12_loop:
  i11 = i9+i1;
  i12 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i10, source_0d, OOC_UINT32, 5779))*2);
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index(i11, dest_0d, OOC_UINT32, 5751))) = (i12>>8);
  i12 = i9+i2;
  i13 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i10, source_0d, OOC_UINT32, 5831))*2);
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index(i12, dest_0d, OOC_UINT32, 5804))) = (_mod(i13,256));
  i13 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i10, source_0d, OOC_UINT32, 5862))*2);
  i13 = (OOC_UINT16)i13<(OOC_UINT16)55296u;
  if (i13) goto l19;
  i13 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i10, source_0d, OOC_UINT32, 5895))*2);
  i13 = (OOC_UINT16)i13>=(OOC_UINT16)57344u;
  if (i13) goto l17;
  i13=0u;
  goto l21;
l17:
  i13 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i10, source_0d, OOC_UINT32, 5919))*2);
...
l21:
  if (i13) goto l35;
  i13 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i10, source_0d, OOC_UINT32, 5985))*2);
  i13 = (OOC_UINT16)i13<(OOC_UINT16)56320u;
  if (i13) goto l25;
  i13=0u;
  goto l27;
l25:
  i13 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index((i10+1), source_0d, OOC_UINT32, 6030))*2);
...
l27:
  ...
  goto l31;
l29:
  i13 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index((i10+1), source_0d, OOC_UINT32, 6046))*2);
  i13 = (OOC_UINT16)i13<(OOC_UINT16)57344u;
...
l31:
  ...
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index(i11, dest_0d, OOC_UINT32, 6273))) = 0u;
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index(i12, dest_0d, OOC_UINT32, 6333))) = 63u;
  i10 = i10+1;
  i = i10;
  i9 = i9+2;
  j = i9;
...
l33:
  i11 = i9+2;
  i12 = i10+1;
  i13 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i12, source_0d, OOC_UINT32, 6109))*2);
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index((i11+i1), dest_0d, OOC_UINT32, 6079))) = (i13>>8);
  i12 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i12, source_0d, OOC_UINT32, 6167))*2);
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index((i11+i2), dest_0d, OOC_UINT32, 6138))) = (_mod(i12,256));
  i10 = i10+2;
  i = i10;
  i9 = i9+4;
  j = i9;
...
l48:
  ...
  goto l53;
l51:
  i6 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i4, source_0d, OOC_UINT32, 6771))*2);
...
l53:
  if (!i6) goto l65;
l56_loop:
  i6 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i4, source_0d, OOC_UINT32, 6833))*2);
  i6 = XML_UnicodeCodec_UTF16__CodecDesc_Encode_WordsPerEncoding(i6);
  i4 = i4+i6;
  i = i4;
  i6 = i4!=i3;
...
l65:
  ...
  *destDone = i8;
  goto l69;
l68:
  XML_UnicodeCodec_UTF16__CodecDesc_Encode((XML_UnicodeCodec_UTF16__Codec)i0, (void*)(OOC_INT64)source, source_0d, i7, (i4+1), (void*)(OOC_INT64)dest, dest_0d, i8, (i5+5), (void*)(OOC_INT64)sourceDone, (void*)(OOC_INT64)destDone);
l69:
  i6 = *sourceDone;
  i4 = i6==i4;
  if (i4) goto l72;
...
l78:
  ...
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index((i5+i1), dest_0d, OOC_UINT32, 7441))) = 0u;
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index((i5+i2), dest_0d, OOC_UINT32, 7508))) = 63u;
  *destDone = (i5+2);
  *sourceDone = i3;
l81:
  return;
...
XML_UnicodeCodec__Codec XML_UnicodeCodec_UTF16__FactoryDesc_NewCodec(XML_UnicodeCodec_UTF16__Factory f) {
  ...
  i0 = (OOC_INT64)XML_UnicodeCodec_UTF16__NewBE(i0);
...
XML_UnicodeCodec__Codec XML_UnicodeCodec_UTF16__FactoryDesc_NewCodecBOM(XML_UnicodeCodec_UTF16__Factory f, OOC_CHAR8 source[], OOC_LEN source_0d, OOC_INT32 sourceStart, OOC_INT32 sourceEnd, OOC_INT32 *sourceDone) {
  ...
  i2 = i1<i2;
  if (!i2) goto l18;
  i2 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i0, source_0d, OOC_UINT32, 8174)));
  i2 = i2==255u;
  if (i2) goto l5;
  i2=0u;
  goto l7;
l5:
  i2 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i1, source_0d, OOC_UINT32, 8214)));
  i2 = i2==254u;
  
l7:
  if (i2) goto l16;
  i2 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i0, source_0d, OOC_UINT32, 8329)));
  i2 = i2==254u;
  if (i2) goto l11;
  i1=0u;
  goto l13;
l11:
  i1 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i1, source_0d, OOC_UINT32, 8372)));
  i1 = i1==255u;
...
l13:
  ...
  *sourceDone = (i0+2);
  ...
  i1 = (OOC_INT64)XML_UnicodeCodec_UTF16__NewBE(i1);
  return (XML_UnicodeCodec__Codec)i1;
  goto l18;
l16:
  *sourceDone = (i0+2);
  i1 = *(OOC_INT8*)(_check_pointer(i3, 8303));
  i1 = (OOC_INT64)XML_UnicodeCodec_UTF16__NewLE(i1);
  return (XML_UnicodeCodec__Codec)i1;
l18:
  *sourceDone = i0;
...
void XML_UnicodeCodec_UTF16__FactoryDesc_GetEncodingName(XML_UnicodeCodec_UTF16__Factory f, OOC_CHAR8 name[], OOC_LEN name_0d) {
  ...
  _copy_8((const void*)(OOC_CHAR8*)"UTF-16",(void*)(OOC_INT64)name,name_0d);
  return;
  ;
}
...
XML_UnicodeCodec__Codec XML_UnicodeCodec_UTF16__FactoryLEDesc_NewCodec(XML_UnicodeCodec_UTF16__FactoryLE f) {
  ...
  i0 = (OOC_INT64)XML_UnicodeCodec_UTF16__NewLE(i0);
  return (XML_UnicodeCodec__Codec)i0;
  ;
}
...
XML_UnicodeCodec__Codec XML_UnicodeCodec_UTF16__FactoryLEDesc_NewCodecBOM(XML_UnicodeCodec_UTF16__FactoryLE f, OOC_CHAR8 source[], OOC_LEN source_0d, OOC_INT32 sourceStart, OOC_INT32 sourceEnd, OOC_INT32 *sourceDone) {
  ...
  *sourceDone = i0;
  ...
  i3 = i2<i3;
  if (!i3) goto l18;
  i3 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i0, source_0d, OOC_UINT32, 9325)));
  i3 = i3==254u;
  if (i3) goto l5;
  i3=0u;
  goto l7;
l5:
  i3 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i2, source_0d, OOC_UINT32, 9365)));
  i3 = i3==255u;
  
l7:
  if (i3) goto l16;
  i3 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i0, source_0d, OOC_UINT32, 9466)));
  i3 = i3==255u;
  if (i3) goto l11;
  i2=0u;
  goto l13;
l11:
  i2 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i2, source_0d, OOC_UINT32, 9509)));
  i2 = i2==254u;
...
void XML_UnicodeCodec_UTF16__FactoryLEDesc_GetEncodingName(XML_UnicodeCodec_UTF16__FactoryLE f, OOC_CHAR8 name[], OOC_LEN name_0d) {
  ...
  _copy_8((const void*)(OOC_CHAR8*)"UTF-16LE",(void*)(OOC_INT64)name,name_0d);
  return;
  ;
}
...
XML_UnicodeCodec__Codec XML_UnicodeCodec_UTF16__FactoryBEDesc_NewCodecBOM(XML_UnicodeCodec_UTF16__FactoryBE f, OOC_CHAR8 source[], OOC_LEN source_0d, OOC_INT32 sourceStart, OOC_INT32 sourceEnd, OOC_INT32 *sourceDone) {
  ...
  *sourceDone = i0;
  ...
  i3 = i2<i3;
  if (!i3) goto l18;
  i3 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i0, source_0d, OOC_UINT32, 10330)));
  i3 = i3==255u;
  if (i3) goto l5;
  i3=0u;
  goto l7;
l5:
  i3 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i2, source_0d, OOC_UINT32, 10370)));
  i3 = i3==254u;
  
l7:
  if (i3) goto l16;
  i3 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i0, source_0d, OOC_UINT32, 10471)));
  i3 = i3==254u;
  if (i3) goto l11;
  i2=0u;
  goto l13;
l11:
  i2 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i2, source_0d, OOC_UINT32, 10514)));
  i2 = i2==255u;
...
void XML_UnicodeCodec_UTF16__FactoryBEDesc_GetEncodingName(XML_UnicodeCodec_UTF16__FactoryBE f, OOC_CHAR8 name[], OOC_LEN name_0d) {
  ...
  _copy_8((const void*)(OOC_CHAR8*)"UTF-16BE",(void*)(OOC_INT64)name,name_0d);
  return;
  ;
}
...
void OOC_XML_UnicodeCodec_UTF16_init(void) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_XML_UnicodeCodec_UTF16__Factory.baseTypes[0]);
  ...
  i0 = (OOC_INT64)XML_UnicodeCodec_UTF16__factory;
  XML_UnicodeCodec__Register((OOC_CHAR8*)"UTF-16", 7, (XML_UnicodeCodec__Factory)i0);
  i0 = (OOC_INT64)RT0__NewObject(_td_XML_UnicodeCodec_UTF16__FactoryLE.baseTypes[0]);
  ...
  i0 = (OOC_INT64)XML_UnicodeCodec_UTF16__factoryLE;
  XML_UnicodeCodec__Register((OOC_CHAR8*)"UTF-16LE", 9, (XML_UnicodeCodec__Factory)i0);
  i0 = (OOC_INT64)RT0__NewObject(_td_XML_UnicodeCodec_UTF16__FactoryBE.baseTypes[0]);
  ...
  i0 = (OOC_INT64)XML_UnicodeCodec_UTF16__factoryBE;
