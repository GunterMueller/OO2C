...
static XML_UnicodeCodec_Latin1__Codec XML_UnicodeCodec_Latin1__New(OOC_INT8 bom) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_XML_UnicodeCodec_Latin1__Codec.baseTypes[0]);
  i1 = bom;
...
l7:
  i2=i1;i1=i3;
l8_loop:
  i3 = *(OOC_UINT8*)((OOC_INT64)source+(_check_index(i2, source_0d, OOC_UINT32, 1323)));
  *(OOC_UINT16*)((OOC_INT64)dest+(_check_index(i1, dest_0d, OOC_UINT32, 1302))*2) = i3;
  i2 = i2+1;
  i1 = i1+1;
  i3 = i2!=i0;
  if (i3) goto l8_loop;
...
l7:
  ...
  i5=i2;i2=i1;
l8_loop:
  i6 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i2, source_0d, OOC_UINT32, 2214))*2);
  i6 = (OOC_UINT16)i6>(OOC_UINT16)255u;
  if (i6) goto l11;
  i6 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i2, source_0d, OOC_UINT32, 2582))*2);
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index(i5, dest_0d, OOC_UINT32, 2562))) = i6;
  i2 = i2+1;
  i = i2;
...
l11:
  ...
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index(i5, dest_0d, OOC_UINT32, 2278))) = 63u;
  i6 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i2, source_0d, OOC_UINT32, 2329))*2);
  i6 = (OOC_UINT16)55296u<=(OOC_UINT16)i6;
  if (i6) goto l14;
  i6=0u;
  goto l16;
l14:
  i6 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i2, source_0d, OOC_UINT32, 2343))*2);
...
l16:
  ...
  goto l20;
l18:
  i6 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index((i2+1), source_0d, OOC_UINT32, 2387))*2);
...
l20:
  ...
  goto l24;
l22:
  i6 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index((i2+1), source_0d, OOC_UINT32, 2403))*2);
...
l37:
  ...
  goto l45;
l40:
  i1 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i0, source_0d, OOC_UINT32, 2941))*2);
  i1 = (OOC_UINT16)i1<(OOC_UINT16)256u;
  if (i1) goto l43;
  i1 = (OOC_INT64)codec;
  i3 = *(OOC_INT32*)(_check_pointer(i1, 3092));
  *(OOC_INT32*)(_check_pointer(i1, 3092)) = (i3+1);
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index(i2, dest_0d, OOC_UINT32, 3121))) = 63u;
  goto l44;
l43:
  i1 = *(OOC_UINT16*)((OOC_INT64)source+(_check_index(i0, source_0d, OOC_UINT32, 2990))*2);
  *(OOC_UINT8*)((OOC_INT64)dest+(_check_index(i2, dest_0d, OOC_UINT32, 2970))) = i1;
l44:
  i1 = i2+1;
  i0 = i0+1;
...
XML_UnicodeCodec_Latin1__Codec XML_UnicodeCodec_Latin1__FactoryDesc_NewCodec(XML_UnicodeCodec_Latin1__Factory f) {
  ...
  i0 = (OOC_INT64)XML_UnicodeCodec_Latin1__New(i0);
  return (XML_UnicodeCodec_Latin1__Codec)i0;
  ;
}
...
void XML_UnicodeCodec_Latin1__FactoryDesc_GetEncodingName(XML_UnicodeCodec_Latin1__Factory f, OOC_CHAR8 name[], OOC_LEN name_0d) {
  ...
  _copy_8((const void*)(OOC_CHAR8*)"ISO-8859-1",(void*)(OOC_INT64)name,name_0d);
  return;
  ;
}
...
void OOC_XML_UnicodeCodec_Latin1_init(void) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_XML_UnicodeCodec_Latin1__Factory.baseTypes[0]);
