...
void URI_Scheme_CurrentDoc__Init(URI_Scheme_CurrentDoc__CurrentDoc uri) {
  ...
  i0 = (OOC_INT64)uri;
  URI__InitURI((URI__URI)i0, (Object__String)(OOC_INT64)0);
  return;
  ;
}
...
URI_Scheme_CurrentDoc__CurrentDoc URI_Scheme_CurrentDoc__New(void) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_URI_Scheme_CurrentDoc__CurrentDoc.baseTypes[0]);
...
URI__URI URI_Scheme_CurrentDoc__CurrentDocDesc_Clone(URI_Scheme_CurrentDoc__CurrentDoc uri) {
  ...
  i1 = (OOC_INT64)uri;
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 1544)))), URI__URIDesc_Copy)),URI__URIDesc_Copy)((URI__URI)i1, (URI__URI)i0);
  return (URI__URI)i0;
  ;
}
...
void URI_Scheme_CurrentDoc__CurrentDocDesc_WriteXML(URI_Scheme_CurrentDoc__CurrentDoc uri, TextRider__Writer w) {
  ...
  i0 = (OOC_INT64)w;
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 1757)))), TextRider__WriterDesc_WriteString)),TextRider__WriterDesc_WriteString)((TextRider__Writer)i0, (OOC_CHAR8*)"\012<current-document/>", 21);
  return;
  ;
}
