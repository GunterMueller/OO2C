...
l6:
  ...
  i0 = (OOC_INT64)x;
  i1 = (OOC_INT64)Object__String8Desc_CharsLatin1((Object__String8)(_type_guard(i0, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 1718)))), &_td_Object__String8Desc, 1718)));
...
l17:
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_URI_String__1409.baseTypes[0], i0);
  res = (void*)i0;
  i = 0;
  j = 0;
...
l35:
  ...
  i0 = (OOC_INT64)Object__NewLatin1Region((void*)(_check_pointer(i0, 2280)), i2, 0, i1);
...
l4:
  ...
  i0 = (OOC_INT64)source;
  i0 = (OOC_INT64)Object__String8Desc_CharsLatin1((Object__String8)(_type_guard(i0, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 3164)))), &_td_Object__String8Desc, 3164)));
...
l6:
  ...
  i3 = URI_CharClass__IsMember(i3, (void*)(OOC_INT64)unreserved, unreserved_0d);
  i3 = !i3;
...
l8:
  ...
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 3501)))), ADT_StringBuffer__StringBufferDesc_AppendLatin1Char)),ADT_StringBuffer__StringBufferDesc_AppendLatin1Char)((ADT_StringBuffer__StringBuffer)i1, i3);
  goto l11;
l10:
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 3338)))), ADT_StringBuffer__StringBufferDesc_AppendLatin1Char)),ADT_StringBuffer__StringBufferDesc_AppendLatin1Char)((ADT_StringBuffer__StringBuffer)i1, 37u);
  i3 = _check_pointer(i0, 3405);
  i4 = OOC_ARRAY_LENGTH(i3, 0);
  i3 = *(OOC_UINT8*)(i3+(_check_index(i2, i4, OOC_UINT16, 3405)));
  i3 = URI_String__AppendEscaped_ToHex((i3>>4));
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 3374)))), ADT_StringBuffer__StringBufferDesc_AppendLatin1Char)),ADT_StringBuffer__StringBufferDesc_AppendLatin1Char)((ADT_StringBuffer__StringBuffer)i1, i3);
  i3 = _check_pointer(i0, 3463);
  i4 = OOC_ARRAY_LENGTH(i3, 0);
  i3 = *(OOC_UINT8*)(i3+(_check_index(i2, i4, OOC_UINT16, 3463)));
  i3 = URI_String__AppendEscaped_ToHex((_mod(i3,16)));
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 3432)))), ADT_StringBuffer__StringBufferDesc_AppendLatin1Char)),ADT_StringBuffer__StringBufferDesc_AppendLatin1Char)((ADT_StringBuffer__StringBuffer)i1, i3);
l11:
  i2 = i2+1;
  i = i2;
