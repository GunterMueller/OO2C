...
void OOC_CharClass_init(void) {
  ...
  *(OOC_UINT8*)((OOC_INT64)CharClass__systemEol+(_check_index(0, 3, OOC_UINT8, 2971))) = 10u;
  *(OOC_UINT8*)((OOC_INT64)CharClass__systemEol+(_check_index(1, 3, OOC_UINT8, 2997))) = 0u;
  return;
  ;
}
