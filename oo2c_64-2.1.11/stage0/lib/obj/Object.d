...
RT0__StructDesc _td_Object__Object = { (RT0__Struct[]){&_td_Object__ObjectDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"Object", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_Object__ObjectArray = { (RT0__Struct[]){&_td_Object__Object}, NULL, NULL, &_mid, (OOC_CHAR8*)"ObjectArray", 8, 1, 0, RT0__strOpenArray };
RT0__StructDesc _td_Object__ObjectArrayPtr = { (RT0__Struct[]){&_td_Object__ObjectArray}, NULL, NULL, &_mid, (OOC_CHAR8*)"ObjectArrayPtr", 8, -1, 0, RT0__strPointer };
...
RT0__StructDesc _td_Object__String = { (RT0__Struct[]){&_td_Object__StringDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"String", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_Object__StringArray = { (RT0__Struct[]){&_td_Object__String}, NULL, NULL, &_mid, (OOC_CHAR8*)"StringArray", 8, 1, 0, RT0__strOpenArray };
RT0__StructDesc _td_Object__StringArrayPtr = { (RT0__Struct[]){&_td_Object__StringArray}, NULL, NULL, &_mid, (OOC_CHAR8*)"StringArrayPtr", 8, -1, 0, RT0__strPointer };
...
RT0__StructDesc _td_Object__CharsLatin1 = { (RT0__Struct[]){&_td_Object__4318}, NULL, NULL, &_mid, (OOC_CHAR8*)"CharsLatin1", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_Object__4515 = { (RT0__Struct[]){&RT0__longchar}, NULL, NULL, &_mid, NULL, 2, 1, (1<<RT0__flagAtomic), RT0__strOpenArray };
RT0__StructDesc _td_Object__CharsUTF16 = { (RT0__Struct[]){&_td_Object__4515}, NULL, NULL, &_mid, (OOC_CHAR8*)"CharsUTF16", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_Object__String8 = { (RT0__Struct[]){&_td_Object__String8Desc}, NULL, NULL, &_mid, (OOC_CHAR8*)"String8", 8, -1, 0, RT0__strPointer };
