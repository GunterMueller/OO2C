...
static Msg__Msg Channel__GetError(OOC_INT32 code) {
  ...
  i0 = code;
  i1 = (OOC_INT64)Channel__errorContext;
...
void Channel__ErrorContextDesc_GetTemplate(Channel__ErrorContext context, Msg__Msg msg, Msg__LString templ, OOC_LEN templ_0d) {
  ...
  i0 = (OOC_INT64)msg;
  i0 = *(OOC_INT32*)((_check_pointer(i0, 12179))+16);
  switch (i0) {
  case 1:
    _copy_8((const void*)(OOC_CHAR8*)"Invalid channel descriptor",(void*)(OOC_INT64)str,128);
    goto l16;
  case 2:
    _copy_8((const void*)(OOC_CHAR8*)"Write error",(void*)(OOC_INT64)str,128);
    goto l16;
  case 3:
    _copy_8((const void*)(OOC_CHAR8*)"No space left on device",(void*)(OOC_INT64)str,128);
    goto l16;
  case 4:
    _copy_8((const void*)(OOC_CHAR8*)"Trying to set invalid position",(void*)(OOC_INT64)str,128);
    goto l16;
  case 5:
    _copy_8((const void*)(OOC_CHAR8*)"Trying to read past the end of the file",(void*)(OOC_INT64)str,128);
    goto l16;
  case 6:
    _copy_8((const void*)(OOC_CHAR8*)"Channel has been closed",(void*)(OOC_INT64)str,128);
    goto l16;
  case 7:
    _copy_8((const void*)(OOC_CHAR8*)"Read error",(void*)(OOC_INT64)str,128);
    goto l16;
  case 8:
    _copy_8((const void*)(OOC_CHAR8*)"Invalid token type in input stream",(void*)(OOC_INT64)str,128);
    goto l16;
  case 9:
    _copy_8((const void*)(OOC_CHAR8*)"No read permission for channel",(void*)(OOC_INT64)str,128);
    goto l16;
  case 10:
    _copy_8((const void*)(OOC_CHAR8*)"No write permission for channel",(void*)(OOC_INT64)str,128);
    goto l16;
  case 11:
    _copy_8((const void*)(OOC_CHAR8*)"Error while closing the channel",(void*)(OOC_INT64)str,128);
    goto l16;
  case 12:
    _copy_8((const void*)(OOC_CHAR8*)"No modification time available",(void*)(OOC_INT64)str,128);
    goto l16;
  case 13:
    _copy_8((const void*)(OOC_CHAR8*)"Failed to create unique name for temporary file",(void*)(OOC_INT64)str,128);
    goto l16;
  default:
    _copy_8((const void*)(OOC_CHAR8*)"[unknown error code]",(void*)(OOC_INT64)str,128);
    goto l16;
  }
l16:
...
void Channel__ReaderDesc_ClearError(Channel__Reader r) {
  ...
  i0 = (OOC_INT64)r;
  *(OOC_INT64*)((_check_pointer(i0, 18059))+8) = (OOC_INT64)0;
  return;
  ;
}
...
void Channel__WriterDesc_ClearError(Channel__Writer w) {
  ...
  i0 = (OOC_INT64)w;
  *(OOC_INT64*)((_check_pointer(i0, 21563))+8) = (OOC_INT64)0;
  return;
  ;
}
...
Channel__Reader Channel__ChannelDesc_NewReader(Channel__Channel ch) {
  ...
  i0 = (OOC_INT64)ch;
  i1 = *(OOC_UINT8*)((_check_pointer(i0, 23167))+10);
  if (i1) goto l3;
  i1 = (OOC_INT64)Channel__GetError(6);
  *(OOC_INT64*)(_check_pointer(i0, 23237)) = i1;
  goto l4;
l3:
  i1 = (OOC_INT64)Channel__GetError(9);
  *(OOC_INT64*)(_check_pointer(i0, 23187)) = i1;
l4:
...
Channel__Writer Channel__ChannelDesc_NewWriter(Channel__Channel ch) {
  ...
  i0 = (OOC_INT64)ch;
  i1 = *(OOC_UINT8*)((_check_pointer(i0, 24177))+10);
  if (i1) goto l3;
  i1 = (OOC_INT64)Channel__GetError(6);
  *(OOC_INT64*)(_check_pointer(i0, 24248)) = i1;
  goto l4;
l3:
  i1 = (OOC_INT64)Channel__GetError(10);
  *(OOC_INT64*)(_check_pointer(i0, 24197)) = i1;
l4:
...
void Channel__ChannelDesc_ClearError(Channel__Channel ch) {
  ...
  i0 = (OOC_INT64)ch;
  *(OOC_INT64*)(_check_pointer(i0, 26041)) = 0;
  return;
  ;
}
...
void OOC_Channel_init(void) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_Channel__ErrorContext.baseTypes[0]);
