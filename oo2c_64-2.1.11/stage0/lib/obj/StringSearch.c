...
void StringSearch__InitMatchObject(StringSearch__MatchObject m, OOC_INT32 pos, OOC_INT32 endpos, StringSearch__Matcher matcher, Object__String8 string) {
  ...
  *(OOC_INT32*)((_check_pointer(i0, 3879))+4) = i1;
  i1 = (OOC_INT64)matcher;
  *(OOC_INT64*)((_check_pointer(i0, 3904))+8) = i1;
  i1 = (OOC_INT64)string;
  *(OOC_INT64*)((_check_pointer(i0, 3931))+16) = i1;
  return;
  ;
}
...
void StringSearch__MatchObjectDesc_Destroy(StringSearch__MatchObject m) {
  ...
  *(OOC_INT64*)((_check_pointer(i0, 4062))+8) = 0;
  *(OOC_INT64*)((_check_pointer(i0, 4085))+16) = 0;
  return;
  ;
}
...
void StringSearch__InitMatcher(StringSearch__Matcher matcher, Object__String8 pattern, OOC_UINT32 flags, OOC_INT32 groups) {
  ...
  i0 = (OOC_INT64)matcher;
  i1 = (OOC_INT64)pattern;
  *(OOC_INT64*)(_check_pointer(i0, 5234)) = i1;
  i1 = flags;
  *(OOC_UINT32*)((_check_pointer(i0, 5267))+8) = i1;
  i1 = groups;
  *(OOC_INT32*)((_check_pointer(i0, 5296))+12) = i1;
  return;
  ;
}
...
void StringSearch__MatcherDesc_Destroy(StringSearch__Matcher matcher) {
  ...
  i0 = (OOC_INT64)matcher;
  *(OOC_INT64*)(_check_pointer(i0, 5394)) = 0;
  *(OOC_UINT32*)((_check_pointer(i0, 5423))+8) = 0u;
  *(OOC_INT32*)((_check_pointer(i0, 5449))+12) = 0;
  return;
  ;
}
