...
OOC_INT8 RealConv__FormatReal(const OOC_CHAR8 str__ref[], OOC_LEN str_0d) {
  ...
  i0 = Real0__FormatReal((void*)(OOC_INT64)str, str_0d, 38, (OOC_CHAR8*)"340282347", 10);
  return i0;
  ;
}
...
OOC_REAL32 RealConv__ValueReal(const OOC_CHAR8 str__ref[], OOC_LEN str_0d) {
  ...
  OOC_INITIALIZE_VPAR(str__ref,str,OOC_CHAR8 ,str_0d)
  i0 = *(OOC_UINT8*)((OOC_INT64)str+(_check_index(0, str_0d, OOC_UINT32, 2407)));
...
l4_loop:
  i0 = i0+1;
  i1 = *(OOC_UINT8*)((OOC_INT64)str+(_check_index(i0, str_0d, OOC_UINT32, 2407)));
  i1 = CharClass__IsWhiteSpace(i1);
  if (i1) goto l4_loop;
l9:
  i0 = sscanf(((OOC_INT64)str+(_check_index(i0, str_0d, OOC_UINT32, 2518))), (OOC_CHAR8*)"%f", (OOC_INT64)&value);
  i0 = i0==1;
  if (i0) goto l12;
