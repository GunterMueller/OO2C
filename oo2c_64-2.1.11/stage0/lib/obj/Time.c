...
void Time__InitTimeStamp(struct Time__TimeStamp *t, RT0__Struct t__tag, OOC_INT32 days, OOC_INT32 msecs) {
  ...
  i0 = msecs;
  i1 = days;
  *(OOC_INT32*)((OOC_INT64)t+4) = (_mod(i0,86400000));
  *(OOC_INT32*)(OOC_INT64)t = (i1+(_div(i0,86400000)));
  return;
  ;
}
...
void Time__GetTime(struct Time__TimeStamp *t, RT0__Struct t__tag) {
  ...
  i0 = SysClock__GetTimeOfDay((void*)(OOC_INT64)&sec, (void*)(OOC_INT64)&usec);
  i0 = sec;
  i1 = usec;
  *(OOC_INT32*)(OOC_INT64)t = (40587+(_div(i0,86400)));
  *(OOC_INT32*)((OOC_INT64)t+4) = (((_mod(i0,86400))*1000)+(_div(i1,1000)));
  return;
  ;
}
...
void Time__TimeStamp_Add(struct Time__TimeStamp *a, RT0__Struct a__tag, const struct Time__Interval *b__ref) {
  ...
  i0 = (OOC_INT64)a+4;
  i1 = *(OOC_INT32*)((OOC_INT64)b+4);
  i2 = *(OOC_INT32*)i0;
  *(OOC_INT32*)i0 = (i2+i1);
  i1 = *(OOC_INT32*)(OOC_INT64)a;
  i2 = *(OOC_INT32*)(OOC_INT64)b;
  *(OOC_INT32*)(OOC_INT64)a = (i1+i2);
  i1 = *(OOC_INT32*)i0;
  i2 = i1>=86400000;
  if (!i2) goto l4;
  *(OOC_INT32*)i0 = (i1-86400000);
  i0 = *(OOC_INT32*)(OOC_INT64)a;
  *(OOC_INT32*)(OOC_INT64)a = (i0+1);
l4:
  return;
  ;
}
...
void Time__TimeStamp_Delta(struct Time__TimeStamp *a, RT0__Struct a__tag, const struct Time__TimeStamp *b__ref, struct Time__Interval *c, RT0__Struct c__tag) {
  ...
  i0 = *(OOC_INT32*)((OOC_INT64)b+4);
  i1 = *(OOC_INT32*)((OOC_INT64)a+4);
  i2 = (OOC_INT64)c+4;
  i3 = *(OOC_INT32*)(OOC_INT64)a;
  i4 = *(OOC_INT32*)(OOC_INT64)b;
  *(OOC_INT32*)i2 = (i1-i0);
  *(OOC_INT32*)(OOC_INT64)c = (i3-i4);
  i0 = *(OOC_INT32*)i2;
  i1 = i0<0;
  if (!i1) goto l4;
  *(OOC_INT32*)i2 = (i0+86400000);
  i0 = *(OOC_INT32*)(OOC_INT64)c;
  *(OOC_INT32*)(OOC_INT64)c = (i0-1);
l4:
  return;
  ;
}
...
OOC_INT8 Time__TimeStamp_Cmp(struct Time__TimeStamp *a, RT0__Struct a__tag, const struct Time__TimeStamp *b__ref) {
  ...
  goto l9;
l5:
  i2 = *(OOC_INT32*)((OOC_INT64)a+4);
  i3 = *(OOC_INT32*)((OOC_INT64)b+4);
  i2 = i2>i3;
...
void Time__InitInterval(struct Time__Interval *_int, RT0__Struct _int__tag, OOC_INT32 days, OOC_INT32 msecs) {
  ...
  i0 = msecs;
  i1 = days;
  *(OOC_INT32*)(OOC_INT64)_int = (i1+(_div(i0,86400000)));
  *(OOC_INT32*)((OOC_INT64)_int+4) = (_mod(i0,86400000));
  return;
  ;
}
