...
void LRealConv__ScanReal(OOC_CHAR8 inputCh, OOC_INT8 *chClass, ConvTypes__ScanState *nextState) {
  ...
  i0 = inputCh;
  Real0__ScanReal(i0, (void*)(OOC_INT64)chClass, (void*)(OOC_INT64)nextState);
  return;
  ;
}
...
OOC_INT8 LRealConv__FormatReal(const OOC_CHAR8 str__ref[], OOC_LEN str_0d) {
  ...
  i0 = Real0__FormatReal((void*)(OOC_INT64)str, str_0d, 308, (OOC_CHAR8*)"17976931348623157", 18);
  return i0;
  ;
}
...
OOC_REAL64 LRealConv__ValueReal(const OOC_CHAR8 str__ref[], OOC_LEN str_0d) {
  ...
  OOC_INITIALIZE_VPAR(str__ref,str,OOC_CHAR8 ,str_0d)
  i0 = *(OOC_UINT8*)((OOC_INT64)str+(_check_index(0, str_0d, OOC_UINT32, 2440)));
...
l4_loop:
  i0 = i0+1;
  i1 = *(OOC_UINT8*)((OOC_INT64)str+(_check_index(i0, str_0d, OOC_UINT32, 2440)));
  i1 = CharClass__IsWhiteSpace(i1);
  if (i1) goto l4_loop;
l9:
  i0 = sscanf(((OOC_INT64)str+(_check_index(i0, str_0d, OOC_UINT32, 2551))), (OOC_CHAR8*)"%lf", (OOC_INT64)&value);
  i0 = i0==1;
  if (i0) goto l12;
