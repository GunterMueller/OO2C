...
Config_Source_Environment__Environment Config_Source_Environment__New(void) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_Config_Source_Environment__Environment.baseTypes[0]);
  env = (Config_Source_Environment__Environment)i0;
  Config_Source_Environment__Init((Config_Source_Environment__Environment)i0);
  *(OOC_INT64*)(_check_pointer(i0, 1772)) = 0;
  *(OOC_INT64*)((_check_pointer(i0, 1807))+8) = 0;
...
void Config_Source_Environment__CommandDesc_DoNotWrite(Config_Source_Environment__Command command) {
  ...
  *(OOC_UINT8*)((_check_pointer(i0, 2009))+24) = 1u;
  return;
  ;
}
...
void Config_Source_Environment__VariableTemplateDesc_INIT(Config_Source_Environment__VariableTemplate t, Object__String8 name, Object__String8 transformation, OOC_CHAR8 isList, OOC_CHAR8 listSep) {
  ...
  i0 = (OOC_INT64)t;
  *(OOC_INT64*)(_check_pointer(i0, 2210)) = 0;
  i1 = (OOC_INT64)name;
  *(OOC_INT64*)((_check_pointer(i0, 2229))+8) = i1;
  i1 = (OOC_INT64)transformation;
  *(OOC_INT64*)((_check_pointer(i0, 2249))+16) = i1;
  i1 = isList;
  *(OOC_UINT8*)((_check_pointer(i0, 2282))+24) = i1;
  i1 = listSep;
  *(OOC_UINT8*)((_check_pointer(i0, 2306))+25) = i1;
  return;
  ;
}
...
Config_Source_Environment__VariableTemplate Config_Source_Environment__EnvironmentDesc_AddVariableTemplate(Config_Source_Environment__Environment env, Object__String8 name, Object__String8 transformation) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_Config_Source_Environment__VariableTemplate.baseTypes[0]);
  i1 = (OOC_INT64)transformation;
  i2 = (OOC_INT64)name;
...
l4:
      ...
      i0 = (OOC_INT64)RT0__NewObject(_td_Config_Source_Environment__Command.baseTypes[0]);
      cmd = (Config_Source_Environment__Command)i0;
      *(OOC_INT64*)(_check_pointer(i0, 3809)) = 0;
      i1 = (OOC_INT64)t;
      *(OOC_INT64*)((_check_pointer(i0, 3840))+8) = i1;
      i1 = (OOC_INT64)value;
      *(OOC_INT64*)((_check_pointer(i0, 3866))+16) = (_type_guard(i1, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 3893)))), &_td_Object__String8Desc, 3893));
      *(OOC_UINT8*)((_check_pointer(i0, 3912))+24) = 0u;
      i0 = (OOC_INT64)env;
      Config_Source_Environment__EnvironmentDesc_Parse_AddCommand_Append((void*)((_check_pointer(i0, 3952))+8));
      return;
      ;
    }
  ...
  i0 = (OOC_INT64)env;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 4010));
  t = (Config_Source_Environment__VariableTemplate)i0;
  i1 = i0!=0;
  if (!i1) goto l27;
l3_loop:
  i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 4095))+8);
  i1 = (OOC_INT64)OS_ProcessParameters__GetEnv((Object__String)i1);
  value = (Object__String)i1;
  i2 = i1!=0;
  if (!i2) goto l22;
  i2 = *(OOC_UINT8*)((_check_pointer(i0, 4143))+24);
  if (i2) goto l8;
...
l9_loop:
  i0 = (OOC_INT64)t;
  i1 = (OOC_INT64)value;
  i2 = *(OOC_UINT8*)((_check_pointer(i0, 4234))+25);
  i3 = i;
  i2 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 4224)))), Object__StringDesc_IndexOf)),Object__StringDesc_IndexOf)((Object__String)i1, i2, i3);
  j = i2;
  i4 = i2<0;
  if (i4) goto l12;
  i1 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 4400)))), Object__StringDesc_Substring)),Object__StringDesc_Substring)((Object__String)i1, i3, i2);
...
l12:
  ...
  i1 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 4304)))), Object__StringDesc_Substring)),Object__StringDesc_Substring)((Object__String)i1, i3, i4);
  entry = (Object__String)i1;
  i = i2;
...
l22:
  i0 = (OOC_INT64)t;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 4699));
  t = (Config_Source_Environment__VariableTemplate)i0;
  i1 = i0!=0;
  if (i1) goto l3_loop;
l27:
...
l52:
      ...
      OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i3, 5472)))), IO_TextRider__WriterDesc_WriteStringRegion)),IO_TextRider__WriterDesc_WriteStringRegion)((IO_TextRider__Writer)i3, (void*)(_check_pointer(i1, 5498)), i5, i2, i4);
      i2 = i4!=i0;
      if (i2) goto l55;
      i2=i4;
      goto l64;
l55:
      ...
      switch (i2) {
      case 38u:
        OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i3, 5580)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i3, (OOC_CHAR8*)"&amp;", 6);
        goto l63;
      case 60u:
        OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i3, 5622)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i3, (OOC_CHAR8*)"&lt;", 5);
        goto l63;
      case 62u:
        OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i3, 5663)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i3, (OOC_CHAR8*)"&gt;", 5);
        goto l63;
      case 39u:
        OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i3, 5704)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i3, (OOC_CHAR8*)"&apos;", 7);
        goto l63;
      case 34u:
        OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i3, 5747)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i3, (OOC_CHAR8*)"&quot;", 7);
        goto l63;
      default:
...
l69:
  ...
  if (!i1) goto l3;
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 6007)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i0, (OOC_CHAR8*)"<?xml version=\0471.0\047 encoding=\047ISO-8859-1\047 standalone=\047yes\047?>", 61);
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 6094)))), IO_TextRider__WriterDesc_WriteLn)),IO_TextRider__WriterDesc_WriteLn)((IO_TextRider__Writer)i0);
  LongStrings__Short((void*)(OOC_INT64)rootTag, rootTag_0d, 63u, (void*)(OOC_INT64)root8, 1024);
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 6159)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i0, (OOC_CHAR8*)"<", 2);
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 6187)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i0, (void*)(OOC_INT64)root8, 1024);
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 6217)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i0, (OOC_CHAR8*)">", 2);
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 6245)))), IO_TextRider__WriterDesc_WriteLn)),IO_TextRider__WriterDesc_WriteLn)((IO_TextRider__Writer)i0);
l3:
  i0 = (OOC_INT64)env;
  i0 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 6287))+8);
  command = (Config_Source_Environment__Command)i0;
  i1 = i0!=(OOC_INT64)0;
  if (!i1) goto l47;
l6_loop:
  i1 = *(OOC_UINT8*)((_check_pointer(i0, 6348))+24);
  i1 = !i1;
  if (!i1) goto l42;
  i0 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 6392))+8);
  i0 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 6402))+16);
...
l33:
  ...
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i3, 6814)))), IO_TextRider__WriterDesc_WriteStringRegion)),IO_TextRider__WriterDesc_WriteStringRegion)((IO_TextRider__Writer)i3, (void*)(_check_pointer(i1, 6840)), i4, i0, i2);
  i0=i2;
  goto l36;
l35:
  i3 = (OOC_INT64)w;
  i4 = OOC_ARRAY_LENGTH((_check_pointer(i1, 6705)), 0);
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i3, 6679)))), IO_TextRider__WriterDesc_WriteStringRegion)),IO_TextRider__WriterDesc_WriteStringRegion)((IO_TextRider__Writer)i3, (void*)(_check_pointer(i1, 6705)), i4, i0, i2);
  i0 = (OOC_INT64)command;
  i0 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 6750))+16);
...
l41:
  i0 = (OOC_INT64)w;
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 6885)))), IO_TextRider__WriterDesc_WriteLn)),IO_TextRider__WriterDesc_WriteLn)((IO_TextRider__Writer)i0);
l42:
  i0 = (OOC_INT64)command;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 6930));
  command = (Config_Source_Environment__Command)i0;
  i1 = i0!=(OOC_INT64)0;
  if (i1) goto l6_loop;
l47:
  ...
  if (!i0) goto l50;
  i0 = (OOC_INT64)w;
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 6992)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i0, (OOC_CHAR8*)"</", 3);
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 7021)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i0, (void*)(OOC_INT64)root8, 1024);
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 7051)))), IO_TextRider__WriterDesc_WriteString)),IO_TextRider__WriterDesc_WriteString)((IO_TextRider__Writer)i0, (OOC_CHAR8*)">", 2);
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 7079)))), IO_TextRider__WriterDesc_WriteLn)),IO_TextRider__WriterDesc_WriteLn)((IO_TextRider__Writer)i0);
l50:
  return;
  ;
}
