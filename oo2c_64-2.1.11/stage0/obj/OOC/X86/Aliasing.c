...
OOC_INT8 OOC_X86_Aliasing__DesignatorAlias(OOC_X86_SSA__Designator instr, OOC_X86_SSA__Designator reference) {
  ...
  auto OOC_CHAR8 OOC_X86_Aliasing__DesignatorAlias_NotHigherLevel(OOC_SymbolTable__Declaration varParam, OOC_SymbolTable__Declaration variable);
    ...
    OOC_CHAR8 OOC_X86_Aliasing__DesignatorAlias_IsVariable(OOC_X86_SSA__Selector sel) {
      ...
      i0 = (OOC_INT64)sel;
      i1 = OOC_TYPE_TEST(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 4680)))), &_td_OOC_X86_SSA__VarDesc);
      if (i1) goto l3;
      i0=0u;
      goto l4;
l3:
      i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer((_type_guard(i0, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 4699)))), &_td_OOC_X86_SSA__VarDesc, 4699)), 4703));
      i0 = *(OOC_UINT8*)((_check_pointer(i0, 4708))+107);
      i0 = !i0;
...
l4:
    ...
    OOC_CHAR8 OOC_X86_Aliasing__DesignatorAlias_IsVarParam(OOC_X86_SSA__Selector sel) {
      ...
      i0 = (OOC_INT64)sel;
      i1 = OOC_TYPE_TEST(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 4870)))), &_td_OOC_X86_SSA__VarDesc);
      if (i1) goto l3;
      i0=0u;
      goto l4;
l3:
      i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer((_type_guard(i0, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 4888)))), &_td_OOC_X86_SSA__VarDesc, 4888)), 4892));
      i0 = *(OOC_UINT8*)((_check_pointer(i0, 4897))+107);
...
l4:
    ...
    OOC_CHAR8 OOC_X86_Aliasing__DesignatorAlias_IsHeapObject(OOC_X86_SSA__Selector sel) {
      ...
      i0 = (OOC_INT64)sel;
      return (OOC_TYPE_TEST(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 5061)))), &_td_OOC_X86_SSA__HeapObjDesc));
      ;
    }
    ...
    OOC_CHAR8 OOC_X86_Aliasing__DesignatorAlias_CompatiblePointers(OOC_SymbolTable__Type a, OOC_SymbolTable__Type b) {
      ...
      if (i2) goto l15;
      i1 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 5244)))), OOC_SymbolTable__TypeDesc_Bound)),OOC_SymbolTable__TypeDesc_Bound)((OOC_SymbolTable__Type)i1);
      a = (OOC_SymbolTable__Type)i1;
      i0 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 5260)))), OOC_SymbolTable__TypeDesc_Bound)),OOC_SymbolTable__TypeDesc_Bound)((OOC_SymbolTable__Type)i0);
...
l4:
      ...
      i9 = (OOC_INT64)*(OOC_INT64*)(i9+(_check_index(i3, i10, OOC_UINT32, 6931))*8);
      i7 = (OOC_INT64)*(OOC_INT64*)(i7+(_check_index(i3, i8, OOC_UINT32, 6931))*8);
      i4 = (OOC_INT64)*(OOC_INT64*)(i4+(_check_index(i5, i6, OOC_UINT32, 6966))*8);
      i4 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i9, 6943)))), OOC_X86_SSA__SelectorDesc_SameSelector)),OOC_X86_SSA__SelectorDesc_SameSelector)((OOC_X86_SSA__Selector)i7, (OOC_X86_SSA__Selector)i4);
      if (i4) goto l11;
...
l20:
    ...
    OOC_CHAR8 OOC_X86_Aliasing__DesignatorAlias_NotHigherLevel(OOC_SymbolTable__Declaration varParam, OOC_SymbolTable__Declaration variable) {
      ...
      i0 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 7738)))), OOC_SymbolTable__ItemDesc_Procedure)),OOC_SymbolTable__ItemDesc_Procedure)((OOC_SymbolTable__Item)i0);
      pVariable = (OOC_SymbolTable__Item)i0;
      i1 = i0==(OOC_INT64)0;
      if (i1) goto l12;
      i1 = (OOC_INT64)varParam;
      i1 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 7979)))), OOC_SymbolTable__ItemDesc_Procedure)),OOC_SymbolTable__ItemDesc_Procedure)((OOC_SymbolTable__Item)i1);
      pVarParam = (OOC_SymbolTable__Item)i1;
      
l3_loop:
      i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i1, 8040))+8);
      pVarParam = (OOC_SymbolTable__Item)i1;
      i2 = i1==(OOC_INT64)0;
      if (i2) goto l6;
      i3 = i1==i0;
...
l13:
  ...
  i1 = (OOC_INT64)*(OOC_INT64*)(i1+(_check_index(0, i2, OOC_UINT8, 8210))*8);
...
l3:
  ...
  i2 = OOC_ARRAY_LENGTH(i1, 0);
  i1 = (OOC_INT64)*(OOC_INT64*)(i1+(_check_index(0, i2, OOC_UINT8, 8237))*8);
  i1 = OOC_X86_Aliasing__DesignatorAlias_IsVariable((OOC_X86_SSA__Selector)i1);
...
l5:
  ...
  i2 = OOC_ARRAY_LENGTH(i1, 0);
  i1 = (OOC_INT64)*(OOC_INT64*)(i1+(_check_index(0, i2, OOC_UINT8, 8938))*8);
...
l9:
  ...
  i2 = OOC_ARRAY_LENGTH(i1, 0);
  i1 = (OOC_INT64)*(OOC_INT64*)(i1+(_check_index(0, i2, OOC_UINT8, 8967))*8);
  i1 = OOC_X86_Aliasing__DesignatorAlias_IsHeapObject((OOC_X86_SSA__Selector)i1);
...
l26:
  ...
  i3 = OOC_ARRAY_LENGTH(i2, 0);
  i2 = (OOC_INT64)*(OOC_INT64*)(i2+(_check_index(0, i3, OOC_UINT8, 9876))*8);
  i2 = OOC_X86_Aliasing__DesignatorAlias_IsVarParam((OOC_X86_SSA__Selector)i2);
  if (i2) goto l29;
  i2=0u;
  goto l31;
l29:
  ...
  i6 = (OOC_INT64)*(OOC_INT64*)(i6+(_check_index(0, i7, OOC_UINT8, 9897))*8);
  i2 = (OOC_INT64)*(OOC_INT64*)(i2+(_check_index(0, i3, OOC_UINT8, 9923))*8);
  i3 = (OOC_INT64)*(OOC_INT64*)(i4+(_check_index(0, i5, OOC_UINT8, 9897))*8);
  i2 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i6, 9900)))), OOC_X86_SSA__SelectorDesc_SameSelector)),OOC_X86_SSA__SelectorDesc_SameSelector)((OOC_X86_SSA__Selector)i3, (OOC_X86_SSA__Selector)i2);
  
l31:
  if (i2) goto l53;
  i2 = _check_pointer(i1, 10147);
  i3 = OOC_ARRAY_LENGTH(i2, 0);
  i2 = (OOC_INT64)*(OOC_INT64*)(i2+(_check_index(0, i3, OOC_UINT8, 10147))*8);
...
l35:
  ...
  i2 = OOC_ARRAY_LENGTH(i1, 0);
  i1 = (OOC_INT64)*(OOC_INT64*)(i1+(_check_index(0, i2, OOC_UINT8, 10239))*8);
  i0 = _check_pointer(i0, 10186);
  i2 = OOC_ARRAY_LENGTH(i0, 0);
  i0 = (OOC_INT64)*(OOC_INT64*)(i0+(_check_index(0, i2, OOC_UINT8, 10186))*8);
  i1 = (OOC_INT64)*(OOC_INT64*)(_check_pointer((_type_guard(i1, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 10245)))), &_td_OOC_X86_SSA__VarDesc, 10245)), 10249));
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer((_type_guard(i0, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 10192)))), &_td_OOC_X86_SSA__VarDesc, 10192)), 10196));
...
l37:
  ...
  i0 = (OOC_INT64)*(OOC_INT64*)(i0+(_check_index(0, i3, OOC_UINT8, 10798))*8);
  i1 = (OOC_INT64)*(OOC_INT64*)(i1+(_check_index(0, i2, OOC_UINT8, 10798))*8);
  i0 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 10801)))), OOC_X86_SSA__SelectorDesc_Type)),OOC_X86_SSA__SelectorDesc_Type)((OOC_X86_SSA__Selector)i1);
  ...
  i5 = OOC_ARRAY_LENGTH(i4, 0);
  i4 = (OOC_INT64)*(OOC_INT64*)(i4+(_check_index(0, i5, OOC_UINT8, 10838))*8);
  i2 = (OOC_INT64)*(OOC_INT64*)(i2+(_check_index(0, i3, OOC_UINT8, 10838))*8);
  i2 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i4, 10841)))), OOC_X86_SSA__SelectorDesc_Type)),OOC_X86_SSA__SelectorDesc_Type)((OOC_X86_SSA__Selector)i2);
  ...
  i1 = (OOC_INT64)*(OOC_INT64*)(i1+(_check_index(0, i3, OOC_UINT8, 10940))*8);
  i1 = OOC_X86_Aliasing__DesignatorAlias_IsVarParam((OOC_X86_SSA__Selector)i1);
  if (i1) goto l43;
  i0=0u;
  goto l47;
...
l56:
  ...
  i2 = OOC_ARRAY_LENGTH(i1, 0);
  i1 = (OOC_INT64)*(OOC_INT64*)(i1+(_check_index(0, i2, OOC_UINT8, 9128))*8);
  i0 = _check_pointer(i0, 9070);
  i2 = OOC_ARRAY_LENGTH(i0, 0);
  i0 = (OOC_INT64)*(OOC_INT64*)(i0+(_check_index(0, i2, OOC_UINT8, 9070))*8);
  i1 = (OOC_INT64)*(OOC_INT64*)(_check_pointer((_type_guard(i1, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i1, 9134)))), &_td_OOC_X86_SSA__HeapObjDesc, 9134)), 9142));
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer((_type_guard(i0, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 9076)))), &_td_OOC_X86_SSA__HeapObjDesc, 9076)), 9084));
...
l59:
  ...
  i7 = OOC_ARRAY_LENGTH(i6, 0);
  i6 = (OOC_INT64)*(OOC_INT64*)(i6+(_check_index(0, i7, OOC_UINT8, 9170))*8);
  i1 = (OOC_INT64)*(OOC_INT64*)(i1+(_check_index(0, i2, OOC_UINT8, 9196))*8);
  i2 = (OOC_INT64)*(OOC_INT64*)(i4+(_check_index(0, i5, OOC_UINT8, 9170))*8);
  i1 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i6, 9173)))), OOC_X86_SSA__SelectorDesc_SameSelector)),OOC_X86_SSA__SelectorDesc_SameSelector)((OOC_X86_SSA__Selector)i2, (OOC_X86_SSA__Selector)i1);
  if (i1) goto l62;
...
l66:
  ...
  i7 = OOC_ARRAY_LENGTH(i6, 0);
  i6 = (OOC_INT64)*(OOC_INT64*)(i6+(_check_index(0, i7, OOC_UINT8, 8472))*8);
  i2 = (OOC_INT64)*(OOC_INT64*)(i2+(_check_index(0, i3, OOC_UINT8, 8498))*8);
  i3 = (OOC_INT64)*(OOC_INT64*)(i4+(_check_index(0, i5, OOC_UINT8, 8472))*8);
  i2 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i6, 8475)))), OOC_X86_SSA__SelectorDesc_SameSelector)),OOC_X86_SSA__SelectorDesc_SameSelector)((OOC_X86_SSA__Selector)i3, (OOC_X86_SSA__Selector)i2);
  if (i2) goto l69;
  return 0;
  goto l71;
l69:
