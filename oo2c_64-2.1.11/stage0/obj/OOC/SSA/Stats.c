...
static OOC_SSA_Stats__Stats OOC_SSA_Stats__NewStats(void) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_Stats__Stats.baseTypes[0]);
...
void OOC_SSA_Stats__AddProcBlock(Object__String label, OOC_SSA__ProcBlock pb) {
  ...
  i0 = (OOC_INT64)label;
  i1 = (OOC_INT64)OOC_SSA_Stats__stage;
  i1 = ADT_Dictionary__DictionaryDesc_HasKey((ADT_Dictionary__Dictionary)i1, (Object__Object)i0);
  if (i1) goto l3;
  i1 = (OOC_INT64)OOC_SSA_Stats__NewStats();
  st = (OOC_SSA_Stats__Stats)i1;
  i2 = (OOC_INT64)OOC_SSA_Stats__stage;
  ADT_Dictionary__DictionaryDesc_Set((ADT_Dictionary__Dictionary)i2, (Object__Object)i0, (Object__Object)i1);
  i2 = (OOC_INT64)OOC_SSA_Stats__labels;
  OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i2, 938)))), ADT_ArrayList__ArrayListDesc_Append)),ADT_ArrayList__ArrayListDesc_Append)((ADT_ArrayList__ArrayList)i2, (Object__Object)i0);
  i0=i1;
  goto l4;
l3:
  i1 = (OOC_INT64)OOC_SSA_Stats__stage;
  ...
  i0 = _type_guard(i0, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 857)))), &_td_OOC_SSA_Stats__StatsDesc, 857);
  st = (OOC_SSA_Stats__Stats)i0;
  
l4:
  i1 = (OOC_INT64)pb;
  i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i1, 979))+24);
  instr = (OOC_SSA__Instr)i1;
  i2 = i1!=(OOC_INT64)0;
  if (!i2) goto l12;
l7_loop:
  i2 = *(OOC_INT8*)((_check_pointer(i1, 1044))+72);
  i3 = *(OOC_INT8*)((_check_pointer(i1, 1075))+9);
  i2 = (i2*12)+i3;
  i = i2;
  ...
  *(OOC_INT32*)((_check_pointer(i0, 1098))+(_check_index(i2, 1068, OOC_UINT32, 1104))*4) = (i3+1);
  i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i1, 1130))+56);
  instr = (OOC_SSA__Instr)i1;
  i2 = i1!=(OOC_INT64)0;
  if (i2) goto l7_loop;
l12:
...
l3_loop:
              ...
              i4 = (OOC_INT64)*(OOC_INT64*)(i4+(_check_index(i1, i5, OOC_UINT32, 1934))*8);
              i5 = _check_pointer(i0, 1955);
              i6 = OOC_ARRAY_LENGTH(i5, 0);
              i5 = (OOC_INT64)*(OOC_INT64*)(i5+(_check_index(i1, i6, OOC_UINT32, 1955))*8);
              ...
              i5 = OOC_ARRAY_LENGTH(i4, 0);
              i4 = (OOC_INT64)*(OOC_INT64*)(i4+(_check_index(i1, i5, OOC_UINT32, 2026))*8);
              i5 = _check_pointer(i0, 2047);
              i6 = OOC_ARRAY_LENGTH(i5, 0);
              i5 = (OOC_INT64)*(OOC_INT64*)(i5+(_check_index(i1, i6, OOC_UINT32, 2047))*8);
...
l3_loop:
              ...
              i5 = OOC_ARRAY_LENGTH(i4, 0);
              i4 = (OOC_INT64)*(OOC_INT64*)(i4+(_check_index(i3, i5, OOC_UINT32, 2368))*8);
...
l11:
          ...
          if (!i2) goto l13;
l4_loop:
          i2 = *(OOC_INT32*)((OOC_INT64)o+(_check_index(i0, 1068, OOC_UINT32, 2610))*4);
          i3 = *(OOC_INT32*)((OOC_INT64)o+(_check_index(i1, 1068, OOC_UINT32, 2604))*4);
...
l13:
          ...
          i1 = i1==0;
          if (i1) goto l16;
          i1 = *(OOC_INT32*)((OOC_INT64)o+(_check_index(i0, 1068, OOC_UINT32, 2716))*4);
...
l21:
      ...
      i0=0;
l1_loop:
      *(OOC_INT32*)((OOC_INT64)o+(_check_index(i0, 1068, OOC_UINT32, 3007))*4) = i0;
      i0 = i0+1;
      i1 = i0<=1067;
      if (i1) goto l1_loop;
l5:
...
l6_loop:
      ...
      i2 = i1<0;
      if (i2) goto l15;
      OOC_SSA_Stats__Write_Sort_Swap((void*)((OOC_INT64)o+(_check_index(i0, 1068, OOC_UINT32, 3221))*4), (void*)((OOC_INT64)o+(_check_index(i1, 1068, OOC_UINT32, 3227))*4));
l13:
      i0 = i;
      i0 = i0+1;
      i = i0;
...
l15:
      ...
      if (!i1) goto l23;
l18_loop:
      *(OOC_INT32*)((OOC_INT64)o+(_check_index(i0, 1068, OOC_UINT32, 3331))*4) = (-1);
      i0 = i0+1;
      i1 = i0<1068;
      if (i1) goto l18_loop;
l23:
...
l8:
  ...
  i0 = (OOC_INT64)OOC_SSA_Stats__labels;
  i1 = *(OOC_INT32*)((_check_pointer(i0, 3590))+8);
  i1 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_Stats__1327.baseTypes[0], i1);
  stList = (void*)i1;
  i2 = *(OOC_INT32*)((_check_pointer(i0, 3619))+8);
  i2 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_Stats__1365.baseTypes[0], i2);
  total = (void*)i2;
  i = 0;
  i0 = *(OOC_INT32*)((_check_pointer(i0, 3651))+8);
  i3 = 0<i0;
  if (!i3) goto l8;
  i3=0;
l3_loop:
  i4 = (OOC_INT64)OOC_SSA_Stats__labels;
  i4 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i4, 3691));
  i4 = _check_pointer(i4, 3697);
  i5 = OOC_ARRAY_LENGTH(i4, 0);
  i4 = (OOC_INT64)*(OOC_INT64*)(i4+(_check_index(i3, i5, OOC_UINT32, 3697))*8);
  i5 = (OOC_INT64)OOC_SSA_Stats__stage;
  ...
  i6 = OOC_ARRAY_LENGTH(i5, 0);
  *(OOC_INT64*)(i5+(_check_index(i3, i6, OOC_UINT32, 3715))*8) = (_type_guard(i4, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i4, 3726)))), &_td_OOC_SSA_Stats__StatsDesc, 3726));
...
l8:
  ...
  i0 = (OOC_INT64)OOC_SSA_Stats__labels;
  i0 = *(OOC_INT32*)((_check_pointer(i0, 3841))+8);
  i = 0;
  i1 = 0<i0;
  if (!i1) goto l24;
  i1 = (OOC_INT64)_c0;
  i2=0;
l11_loop:
  i3 = (OOC_INT64)OOC_SSA_Stats__labels;
  i3 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i3, 3869));
  i3 = _check_pointer(i3, 3875);
  i4 = OOC_ARRAY_LENGTH(i3, 0);
  i2 = (OOC_INT64)*(OOC_INT64*)(i3+(_check_index(i2, i4, OOC_UINT32, 3875))*8);
  i2 = _type_guard(i2, ((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i2, 3879)))), &_td_Object__StringDesc, 3879);
  s = (Object__String)i2;
  ...
  i3 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i2, 3933)))), Object__StringDesc_Substring)),Object__StringDesc_Substring)((Object__String)i2, (i3-5), i4);
  sub = (Object__String)i3;
  i3 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i3, 3981)))), Object__StringDesc_Equals)),Object__StringDesc_Equals)((Object__String)i3, (Object__Object)i1);
  if (!i3) goto l19;
  i3 = *(OOC_INT32*)(_check_pointer(i2, 4034));
  i2 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i2, 4019)))), Object__StringDesc_Substring)),Object__StringDesc_Substring)((Object__String)i2, 0, (i3-5));
  s = (Object__String)i2;
...
l24:
  ...
  i0=0;
l25_loop:
  i0 = *(OOC_INT32*)((OOC_INT64)o+(_check_index(i0, 1068, OOC_UINT32, 4216))*4);
  j = i0;
  i1 = i0>=0;
  if (!i1) goto l36;
  OOC_SSA_Opcode__GetName((_div(i0,12)), (_mod(i0,12)), (void*)(OOC_INT64)str, 64);
  i0 = Strings__Length((void*)(OOC_INT64)str, 64);
  OOC_SSA_Stats__Write_Pad(i0, 21);
  Out__String((void*)(OOC_INT64)str, 64);
  i0 = (OOC_INT64)OOC_SSA_Stats__labels;
  i0 = *(OOC_INT32*)((_check_pointer(i0, 4472))+8);
  i = 0;
  i1 = 0<i0;
  if (!i1) goto l35;
  i1 = (OOC_INT64)total;
...
l30_loop:
  ...
  i6 = OOC_ARRAY_LENGTH(i5, 0);
  i5 = (OOC_INT64)*(OOC_INT64*)(i5+(_check_index(i4, i6, OOC_UINT32, 4511))*8);
  ...
  i9 = (OOC_INT64)*(OOC_INT64*)(i9+(_check_index(i4, i10, OOC_UINT32, 4567))*8);
...
l40:
  ...
  i0 = (OOC_INT64)OOC_SSA_Stats__labels;
  i0 = *(OOC_INT32*)((_check_pointer(i0, 4712))+8);
  i = 0;
  i1 = 0<i0;
  if (!i1) goto l48;
  i1 = (OOC_INT64)total;
