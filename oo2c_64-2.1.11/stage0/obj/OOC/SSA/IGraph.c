...
void OOC_SSA_IGraph__GraphDesc_Clear(OOC_SSA_IGraph__Graph g) {
  ...
  i0 = (OOC_INT64)g;
  i1 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 2519));
  i = 0;
  ...
  i2=0;
l3_loop:
  i3 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 2559));
  j = 0;
  ...
  i4=0;
l6_loop:
  i5 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 2582));
...
static void OOC_SSA_IGraph__InitGraph(OOC_SSA_IGraph__Graph g, OOC_INT32 size) {
  ...
  i0 = size;
  i1 = (OOC_INT64)g;
  *(OOC_INT64*)(_check_pointer(i1, 2703)) = ((OOC_INT64)RT0__NewObject(_td_OOC_SSA_IGraph__BitMatrix.baseTypes[0], i0, (((i0+32)-1)>>5)));
  *(OOC_INT32*)((_check_pointer(i1, 2756))+8) = i0;
...
OOC_SSA_IGraph__Graph OOC_SSA_IGraph__NewGraph(OOC_INT32 size) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_IGraph__Graph.baseTypes[0]);
  i1 = size;
...
OOC_SSA_IGraph__Vector OOC_SSA_IGraph__GraphDesc_NewVector(OOC_SSA_IGraph__Graph g) {
  ...
  i0 = (OOC_INT64)g;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 3172));
  i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 3175)), 1);
  i0 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_IGraph__Vector.baseTypes[0], i0);
...
OOC_SSA_IGraph__Vector OOC_SSA_IGraph__GraphDesc_CopyVector(OOC_SSA_IGraph__Graph g, OOC_SSA_IGraph__Vector v) {
  ...
  i0 = (OOC_INT64)v;
  i1 = (OOC_INT64)g;
  i2 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i1, 3468));
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i0, 3457)), 0);
  i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 3471)), 1);
  _assert((i3==i2), 127, 3443);
  i1 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i1, 3497));
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 3500)), 1);
  i1 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_IGraph__Vector.baseTypes[0], i1);
...
void OOC_SSA_IGraph__GraphDesc_Interfere(OOC_SSA_IGraph__Graph g, OOC_INT32 res, OOC_SSA_IGraph__Vector live) {
  ...
  i0 = (OOC_INT64)g;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 3915));
...
void OOC_SSA_IGraph__GraphDesc_MergeRowColumn(OOC_SSA_IGraph__Graph g, OOC_INT32 source, OOC_INT32 target) {
  ...
  i0 = (OOC_INT64)g;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 4140));
  m = (OOC_SSA_IGraph__BitMatrix)i0;
...
OOC_CHAR8 OOC_SSA_IGraph__GraphDesc_Conflicts(OOC_SSA_IGraph__Graph g, OOC_INT32 i, OOC_INT32 j) {
  ...
  i0 = (OOC_INT64)g;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 5542));
  m = (OOC_SSA_IGraph__BitMatrix)i0;
...
OOC_INT32 OOC_SSA_IGraph__GraphDesc_NumberOfConflicts(OOC_SSA_IGraph__Graph g, OOC_INT32 i) {
  ...
  i0 = (OOC_INT64)g;
  i1 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 5746));
  m = (OOC_SSA_IGraph__BitMatrix)i1;
  c = 0;
  i1 = *(OOC_INT32*)((_check_pointer(i0, 5781))+8);
  i2 = 0<i1;
  if (i2) goto l3;
  i0=0;
  goto l13;
...
void OOC_SSA_IGraph__GraphDesc_MergeVector(OOC_SSA_IGraph__Graph g, OOC_SSA_IGraph__Vector source, OOC_SSA_IGraph__Vector dest) {
  ...
  i2 = (OOC_INT64)g;
  i3 = *(OOC_INT32*)((_check_pointer(i2, 6147))+8);
  i4 = 0<i3;
  if (!i4) goto l11;
  i4=0;
l3_loop:
...
void OOC_SSA_IGraph__GraphDesc_SymmetricMatrix(OOC_SSA_IGraph__Graph g) {
  ...
  i0 = (OOC_INT64)g;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 6668));
  m = (OOC_SSA_IGraph__BitMatrix)i0;
  y = 0;
...
void OOC_SSA_IGraph__GraphDesc_AssertSymmetricMatrix(OOC_SSA_IGraph__Graph g) {
  ...
  i0 = (OOC_INT64)g;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 7270));
  m = (OOC_SSA_IGraph__BitMatrix)i0;
  y = 0;
...
OOC_SSA_IGraph__ColorArray OOC_SSA_IGraph__GraphDesc_ColorGraphTrivial(OOC_SSA_IGraph__Graph g) {
  ...
  i1 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_IGraph__ColorArray.baseTypes[0], i1);
  ca = (OOC_SSA_IGraph__ColorArray)i1;
  i = 0;
  i0 = *(OOC_INT32*)((_check_pointer(i0, 7897))+8);
  i2 = 0<i0;
  if (!i2) goto l8;
  i2=0;
l3_loop:
...
OOC_SSA_IGraph__ColorArray OOC_SSA_IGraph__GraphDesc_ColorGraphSimple(OOC_SSA_IGraph__Graph g) {
  ...
  i0 = (OOC_INT64)g;
  i1 = *(OOC_INT32*)((_check_pointer(i0, 8365))+8);
  i1 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_IGraph__ColorArray.baseTypes[0], i1);
  ca = (OOC_SSA_IGraph__ColorArray)i1;
  i2 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 8384));
  m = (OOC_SSA_IGraph__BitMatrix)i2;
  i = 0;
  i0 = *(OOC_INT32*)((_check_pointer(i0, 8408))+8);
  i3 = 0<i0;
  if (!i3) goto l30;
  i3=0;
l3_loop:
...
OOC_SSA_IGraph__ColorArray OOC_SSA_IGraph__GraphDesc_ColorGraphCombinatorial(volatile OOC_SSA_IGraph__Graph g) {
  ...
  Exception__Context _context0;
    ...
    void OOC_SSA_IGraph__GraphDesc_ColorGraphCombinatorial_Try(OOC_INT32 index) {
      ...
      i4=0;
l5_loop:
      i5 = *(OOC_UINT32*)((OOC_INT64)colorAvailableFor+(_check_index(i4, 32, OOC_UINT32, 9661))*4);
      i5 = _in(i0,i5);
      if (!i5) goto l19;
      i5 = (OOC_INT64)ca;
      ...
      *(OOC_INT32*)(i6+(_check_index(i0, i7, OOC_UINT32, 9689))*4) = i4;
      ...
      i6=0;
l10_loop:
      i7 = *(OOC_UINT32*)((OOC_INT64)m+(_check_index(i6, 32, OOC_UINT32, 9772))*4);
      i7 = _in(i0,i7);
      if (!i7) goto l13;
...
l13:
      ...
      if (i7) goto l10_loop;
l18:
      i5 = *(OOC_UINT32*)((OOC_INT64)colorAvailableFor+(_check_index(i4, 32, OOC_UINT32, 9898))*4);
      oldAvail = i5;
      i6 = *(OOC_UINT32*)((OOC_INT64)colorAvailableFor+(_check_index(i4, 32, OOC_UINT32, 9964))*4);
      i7 = *(OOC_UINT32*)((OOC_INT64)m+(_check_index(i0, 32, OOC_UINT32, 9975))*4);
      *(OOC_UINT32*)((OOC_INT64)colorAvailableFor+(_check_index(i4, 32, OOC_UINT32, 9936))*4) = (_logical_subtr(i6,i7));
      OOC_SSA_IGraph__GraphDesc_ColorGraphCombinatorial_Try(i2);
      *(OOC_UINT32*)((OOC_INT64)colorAvailableFor+(_check_index(i4, 32, OOC_UINT32, 10039))*4) = i5;
l19:
      i4 = i4+1;
      color = i4;
      i5 = i4<i1;
      ...
      goto l26;
l25:
      i0 = (OOC_INT64)RT0__NewObject(_td_Exception__Checked.baseTypes[0]);
      Exception__ExceptionDesc_INIT((Exception__Exception)i0, (Object__String)((OOC_INT64)_c0));
...
l26:
    ...
    void OOC_SSA_IGraph__GraphDesc_ColorGraphCombinatorial_Invert(const OOC_INT32 caInverted__ref[], OOC_LEN caInverted_0d) {
      ...
      i0 = (OOC_INT64)g;
      i = 0;
      i0 = *(OOC_INT32*)((_check_pointer(i0, 10344))+8);
      i1 = 0<i0;
      if (!i1) goto l8;
      i1 = (OOC_INT64)ca;
      i2 = (OOC_INT64)p;
...
l3_loop:
      ...
      i6 = OOC_ARRAY_LENGTH(i4, 0);
      i7 = *(OOC_INT32*)((OOC_INT64)caInverted+(_check_index(i3, caInverted_0d, OOC_UINT32, 10385))*4);
...
l8:
  ...
  i0 = (OOC_INT64)g;
  i1 = *(OOC_INT32*)((_check_pointer(i0, 10515))+8);
  i1 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_IGraph__9260.baseTypes[0], i1);
  p = (void*)i1;
  i = 0;
  i2 = *(OOC_INT32*)((_check_pointer(i0, 10542))+8);
  i3 = 0<i2;
  if (!i3) goto l8;
  i3=0;
l3_loop:
  ...
  *(OOC_INT32*)(i4+(_check_index(i3, i5, OOC_UINT32, 10560))*4) = i3;
  ...
  if (i4) goto l3_loop;
l8:
  i0 = *(OOC_INT32*)((_check_pointer(i0, 10598))+8);
  i = 0;
  i1 = 0<i0;
  if (!i1) goto l29;
  i1=0;
l11_loop:
  ...
  i3 = i1+1;
  j = i3;
  i4 = *(OOC_INT32*)((_check_pointer(i2, 10649))+8);
  i5 = i3<i4;
  if (i5) goto l14;
  i2=i1;
  goto l24;
...
l29:
  size = 0;
  i0 = (OOC_INT64)g;
  i1 = *(OOC_INT32*)((_check_pointer(i0, 10907))+8);
  i1 = 0!=i1;
  if (i1) goto l32;
  i1=0u;
  goto l34;
...
l37_loop:
  i2 = i2+1;
  size = i2;
  i3 = *(OOC_INT32*)((_check_pointer(i0, 10907))+8);
  i3 = i2!=i3;
  if (i3) goto l40;
  i3=0u;
  goto l42;
...
l46:
  i2 = i1>32;
  if (!i2) goto l49;
  return (OOC_SSA_IGraph__ColorArray)(OOC_INT64)0;
l49:
  OOC_SSA_IGraph__GraphDesc_AssertSymmetricMatrix((OOC_SSA_IGraph__Graph)i0);
  i2=0;
l50_loop:
  *(OOC_UINT32*)((OOC_INT64)m+(_check_index(i2, 32, OOC_UINT32, 11208))*4) = 0u;
  i2 = i2+1;
  i3 = i2<=31;
  if (i3) goto l50_loop;
l54:
...
l60_loop:
  ...
  if (!i6) goto l63;
  i6 = *(OOC_UINT32*)((OOC_INT64)m+(_check_index(i5, 32, OOC_UINT32, 11342))*4);
  *(OOC_UINT32*)((OOC_INT64)m+(_check_index(i5, 32, OOC_UINT32, 11342))*4) = (_set_bit(i6,i4));
l63:
  i5 = i5+1;
  j = i5;
  i6 = i5<i1;
...
l68:
  ...
  if (i5) goto l57_loop;
l73:
  i0 = *(OOC_INT32*)((_check_pointer(i0, 11399))+8);
  i0 = (OOC_INT64)RT0__NewObject(_td_OOC_SSA_IGraph__ColorArray.baseTypes[0], i0);
...
l76_loop:
  ...
  i2=0;
l79_loop:
  *(OOC_UINT32*)((OOC_INT64)colorAvailableFor+(_check_index(i2, 32, OOC_UINT32, 11657))*4) = i1;
  i2 = i2+1;
  i = i2;
  i3 = i2<i0;
  if (i3) goto l79_loop;
l84:
  i0 = *(OOC_UINT32*)((OOC_INT64)colorAvailableFor+(_check_index(0, 32, OOC_UINT8, 11741))*4);
  i1 = *(OOC_UINT32*)((OOC_INT64)m+(_check_index(0, 32, OOC_UINT8, 11748))*4);
  *(OOC_UINT32*)((OOC_INT64)colorAvailableFor+(_check_index(0, 32, OOC_UINT8, 11717))*4) = (_logical_subtr(i0,i1));
  {
    Exception__PushContext(&_context0, &_target0);
    if (!setjmp(_target0)) goto l91;
    Exception__PopContext(1);
    i0 = OOC_TYPE_TEST(((OOC_INT64)OOC_TYPE_TAG(((OOC_INT64)Exception__Current()))), &_td_Exception__CheckedDesc);
    if (i0) goto l89;
...
l100_loop:
  ...
  i4=0;
l103_loop:
  i5 = *(OOC_UINT32*)((OOC_INT64)m+(_check_index(i4, 32, OOC_UINT32, 12080))*4);
  i5 = _in(i3,i5);
  if (!i5) goto l106;
...
l116:
  i2 = (OOC_INT64)g;
  i = i0;
  i2 = *(OOC_INT32*)((_check_pointer(i2, 12182))+8);
  i3 = i0<i2;
  if (!i3) goto l124;
l119_loop:
...
l124:
  ...
  i3=0;
l127_loop:
  i4 = *(OOC_INT32*)((_check_pointer(i0, 12359))+8);
  j = 0;
  i5 = 0<i4;
  if (!i5) goto l138;
  i5=0;
