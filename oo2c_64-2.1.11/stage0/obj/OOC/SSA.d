...
RT0__StructDesc _td_OOC_SSA__Node = { (RT0__Struct[]){&_td_OOC_SSA__NodeDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"Node", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA__Opnd = { (RT0__Struct[]){&_td_OOC_SSA__OpndDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"Opnd", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA__Result = { (RT0__Struct[]){&_td_OOC_SSA__ResultDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"Result", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA__Instr = { (RT0__Struct[]){&_td_OOC_SSA__InstrDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"Instr", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA__Const = { (RT0__Struct[]){&_td_OOC_SSA__ConstDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"Const", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA__DeclRef = { (RT0__Struct[]){&_td_OOC_SSA__DeclRefDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"DeclRef", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA__TypeRef = { (RT0__Struct[]){&_td_OOC_SSA__TypeRefDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"TypeRef", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA__Address = { (RT0__Struct[]){&_td_OOC_SSA__AddressDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"Address", 8, -1, 0, RT0__strPointer };
