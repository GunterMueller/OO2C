...
OOC_Scanner_InputBuffer__CharArray OOC_Doc_Decoration__Remove(OOC_Scanner_SymList__Symbol sym, OOC_Doc_Decoration__Decoration *deco) {
  ...
  auto OOC_Doc_Decoration__Decoration OOC_Doc_Decoration__Remove_GetDotLineIndent(OOC_Scanner_InputBuffer__CharArray str);
    ...
    OOC_INT32 OOC_Doc_Decoration__Remove_GetIndent(OOC_CHAR8 str[], OOC_LEN str_0d, OOC_INT32 startOfLine, OOC_INT32 indent) {
      ...
      i0 = startOfLine;
      i1 = *(OOC_UINT8*)((OOC_INT64)str+(_check_index(i0, str_0d, OOC_UINT32, 2443)));
      i1 = i1!=0u;
      if (!i1) goto l20;
l3_loop:
      i1 = *(OOC_UINT8*)((OOC_INT64)str+(_check_index(i0, str_0d, OOC_UINT32, 2471)));
      i1 = i1==32u;
      if (i1) goto l14;
      i1 = *(OOC_UINT8*)((OOC_INT64)str+(_check_index(i0, str_0d, OOC_UINT32, 2528)));
      i1 = i1==9u;
      if (i1) goto l12;
      i1 = *(OOC_UINT8*)((OOC_INT64)str+(_check_index(i0, str_0d, OOC_UINT32, 2638)));
      i1 = i1==10u;
      if (i1) goto l10;
      i1 = indent;
      return i1;
...
l19_loop:
      ...
      *(OOC_UINT8*)(i3+(_check_index(i2, i4, OOC_UINT32, 3552))) = 32u;
      ...
      if (i3) goto l19_loop;
l24:
      i2 = (OOC_INT64)RT0__NewObject(_td_OOC_Doc_Decoration__PlainIndent.baseTypes[0]);
      plainIndent = (OOC_Doc_Decoration__PlainIndent)i2;
      i3 = (OOC_INT64)sym;
      i4 = *(OOC_INT32*)((_check_pointer(i3, 3729))+36);
      *(OOC_INT32*)((_check_pointer(i2, 3709))+8) = i4;
      i3 = *(OOC_INT32*)((_check_pointer(i3, 3791))+36);
...
l42:
    ...
    OOC_Doc_Decoration__Decoration OOC_Doc_Decoration__Remove_GetDotLineIndent(OOC_Scanner_InputBuffer__CharArray str) {
      ...
      i0 = (OOC_INT64)str;
      i1 = (OOC_INT64)OOC_Doc_Decoration__Remove_GetPlainIndent((OOC_Scanner_InputBuffer__CharArray)i0);
...
l33:
      ...
      if (i3) goto l3_loop;
l38:
      i0 = (OOC_INT64)RT0__NewObject(_td_OOC_Doc_Decoration__DotLineIndent.baseTypes[0]);
  ...
  i0 = (OOC_INT64)sym;
  i1 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 6567))+16);
  i2 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 6567))+16);
  ...
  i0 = (OOC_INT64)*(OOC_INT64*)((_check_pointer(i0, 6592))+16);
...
l21:
  ...
  *deco = (OOC_Doc_Decoration__Decoration)(OOC_INT64)0;
  i0 = OOC_Doc_Decoration__Remove_IsDotLine((OOC_Scanner_InputBuffer__CharArray)i1);
  if (i0) goto l24;
  i0=(OOC_INT64)0;
  goto l25;
l24:
  i0 = (OOC_INT64)OOC_Doc_Decoration__Remove_GetDotLineIndent((OOC_Scanner_InputBuffer__CharArray)i1);
...
l25:
  ...
  if (!i0) goto l28;
  i0 = (OOC_INT64)str;
  i0 = (OOC_INT64)OOC_Doc_Decoration__Remove_GetPlainIndent((OOC_Scanner_InputBuffer__CharArray)i0);
  *deco = (OOC_Doc_Decoration__Decoration)i0;
l28:
  i0 = (OOC_INT64)str;
...
OOC_Scanner_InputBuffer__CharArray OOC_Doc_Decoration__PlainIndentDesc_Decorate(OOC_Doc_Decoration__PlainIndent d, OOC_Scanner_InputBuffer__CharArray s) {
  ...
  len = i1;
  i2 = (OOC_INT64)RT0__NewObject(_td_OOC_Scanner_InputBuffer__CharArray.baseTypes[0], ((i1+3)+5));
...
l12:
  if (i0) goto l14;
  _copy_8((const void*)(OOC_CHAR8*)"(*x",(void*)(OOC_INT64)ins,4);
  *(OOC_UINT8*)((OOC_INT64)ins+(_check_index(2, 4, OOC_UINT8, 8089))) = 10u;
  i0 = OOC_ARRAY_LENGTH((_check_pointer(i2, 8143)), 0);
  Strings__Insert((void*)(OOC_INT64)ins, 4, 0, (void*)(_check_pointer(i2, 8143)), i0);
  goto l15;
l14:
