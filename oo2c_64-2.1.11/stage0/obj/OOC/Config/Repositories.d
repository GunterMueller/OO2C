...
RT0__StructDesc _td_OOC_Config_Repositories__Section = { (RT0__Struct[]){&_td_OOC_Config_Repositories__SectionDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"Section", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_Config_Repositories__1204 = { (RT0__Struct[]){&_td_OOC_Repository__Module}, NULL, NULL, &_mid, NULL, 8, 1, 0, RT0__strOpenArray };
RT0__StructDesc _td_OOC_Config_Repositories__ModuleList = { (RT0__Struct[]){&_td_OOC_Config_Repositories__1204}, NULL, NULL, &_mid, (OOC_CHAR8*)"ModuleList", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_Config_Repositories__SectionDesc = { (RT0__Struct[]){&_td_Config_Section__SectionDesc,&_td_OOC_Config_Repositories__SectionDesc}, (void*[]){(void*)OOC_Config_Repositories__SectionDesc_ProcessElements,(void*)OOC_Config_Repositories__SectionDesc_DumpContent,(void*)OOC_Config_Repositories__SectionDesc_GetModule,(void*)OOC_Config_Repositories__SectionDesc_GetResource,(void*)OOC_Config_Repositories__SectionDesc_GetIncludePaths}, NULL, &_mid, (OOC_CHAR8*)"SectionDesc", 32, 1, 0, RT0__strRecord };
RT0__StructDesc _td_OOC_Config_Repositories__RepositoryEntry = { (RT0__Struct[]){&_td_OOC_Config_Repositories__RepositoryEntryDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"RepositoryEntry", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_Config_Repositories__RepositoryEntryDesc = { (RT0__Struct[]){&_td_OOC_Config_Repositories__RepositoryEntryDesc}, (void*[]){(void*)OOC_Config_Repositories__RepositoryEntryDesc_ProcessElement}, NULL, &_mid, (OOC_CHAR8*)"RepositoryEntryDesc", 72, 0, 0, RT0__strRecord };
...
RT0__StructDesc _td_OOC_Config_Repositories__ErrorContext = { (RT0__Struct[]){&_td_OOC_Config_Repositories__ErrorContextDesc}, NULL, NULL, &_mid, (OOC_CHAR8*)"ErrorContext", 8, -1, 0, RT0__strPointer };
RT0__StructDesc _td_OOC_Config_Repositories__ErrorContextDesc = { (RT0__Struct[]){&_td_Msg__ContextDesc,&_td_XML_Error__ContextDesc,&_td_Config_Section__ErrorContextDesc,&_td_OOC_Config_Repositories__ErrorContextDesc}, (void*[]){(void*)OOC_Config_Repositories__ErrorContextDesc_GetTemplate,(void*)XML_Error__ContextDesc_WriteTemplate,(void*)XML_Error__ContextDesc_SetString}, NULL, &_mid, (OOC_CHAR8*)"ErrorContextDesc", 16, 3, 0, RT0__strRecord };
