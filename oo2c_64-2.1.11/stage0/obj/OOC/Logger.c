...
static void OOC_Logger__WriteURI(URI__URI uri) {
  ...
  if (!i0) goto l7;
  i0 = (OOC_INT64)uri;
  i1 = OOC_TYPE_TEST(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 304)))), &_td_URI_Scheme_File__URIDesc);
  if (i1) goto l5;
  i0 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 386)))), URI__URIDesc_ToString)),URI__URIDesc_ToString)((URI__URI)i0);
...
l5:
  ...
  Out__String((void*)(OOC_INT64)rule, rule_0d);
  Out__String((OOC_CHAR8*)" for ", 6);
  Out__String((void*)(OOC_INT64)module, module_0d);
  Out__Ln();
  i0 = OOC_Logger__indentMake;
...
l5:
  if (!i0) goto l7;
  OOC_Logger__IndentMake();
  Out__String((void*)(OOC_INT64)s1, s1_0d);
  Out__Ln();
l7:
  return;
  ;
...
l5:
  ...
  i0 = (OOC_INT64)uri1;
  OOC_Logger__WriteURI((URI__URI)i0);
  Out__String((void*)(OOC_INT64)s2, s2_0d);
  Out__Ln();
l7:
  return;
  ;
...
l5:
  ...
  i0 = (OOC_INT64)uri2;
  OOC_Logger__WriteURI((URI__URI)i0);
  Out__String((void*)(OOC_INT64)s3, s3_0d);
  Out__Ln();
l7:
  return;
  ;
