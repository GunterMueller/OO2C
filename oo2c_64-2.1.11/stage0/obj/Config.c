...
Config__BooleanVar Config__NewBooleanVar(OOC_CHAR8 boolean) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_Config__BooleanVar.baseTypes[0]);
...
void Config__BooleanVarDesc_StringToValue(Config__BooleanVar v, Object__String str) {
  ...
  goto l5;
l3:
  i1 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 1544)))), Object__StringDesc_CharAt)),Object__StringDesc_CharAt)((Object__String)i0, 0);
...
l8_loop:
  ...
  goto l13;
l11:
  i2 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 1544)))), Object__StringDesc_CharAt)),Object__StringDesc_CharAt)((Object__String)i0, i1);
...
l17:
  ...
  goto l22;
l20:
  i3 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 1702)))), Object__StringDesc_CharAt)),Object__StringDesc_CharAt)((Object__String)i0, (i2-1));
...
l30:
  if (i3) goto l25_loop;
l34:
  i0 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 1770)))), Object__StringDesc_Substring)),Object__StringDesc_Substring)((Object__String)i0, i1, i2);
  strip = (Object__String)i0;
  i2 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 1804)))), Object__StringDesc_Equals)),Object__StringDesc_Equals)((Object__String)i0, (Object__Object)((OOC_INT64)_c0));
  if (i2) goto l41;
  i0 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 1865)))), Object__StringDesc_Equals)),Object__StringDesc_Equals)((Object__String)i0, (Object__Object)((OOC_INT64)_c1));
  if (i0) goto l39;
  i0 = (OOC_INT64)RT0__NewObject(_td_Exception__ParseError.baseTypes[0]);
  Exception__ParseErrorDesc_INIT((Exception__ParseError)i0, (Object__String)((OOC_INT64)_c2), i1);
...
Config__BooleanVar Config__BooleanVarDesc_Clone(Config__BooleanVar v) {
  ...
  i3 = (OOC_INT64)&_td_Config__BooleanVarDesc;
  i3 = i3!=i3;
  if (!i3) goto l4;
...
Config__IntegerVar Config__NewIntegerVar(OOC_INT32 _int) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_Config__IntegerVar.baseTypes[0]);
...
void Config__IntegerVarDesc_StringToValue(Config__IntegerVar v, Object__String str) {
  ...
  goto l5;
l3:
  i1 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 2812)))), Object__StringDesc_CharAt)),Object__StringDesc_CharAt)((Object__String)i0, 0);
  i1 = (OOC_UINT32)i1<=(OOC_UINT32)32u;
...
l8_loop:
  ...
  goto l13;
l11:
  i2 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 2812)))), Object__StringDesc_CharAt)),Object__StringDesc_CharAt)((Object__String)i0, i1);
  i2 = (OOC_UINT32)i2<=(OOC_UINT32)32u;
...
l17:
  ...
  goto l22;
l20:
  i3 = OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 2970)))), Object__StringDesc_CharAt)),Object__StringDesc_CharAt)((Object__String)i0, (i2-1));
  i3 = (OOC_UINT32)i3<=(OOC_UINT32)32u;
...
l30:
  if (i3) goto l25_loop;
l34:
  i0 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 3033)))), Object__StringDesc_Substring)),Object__StringDesc_Substring)((Object__String)i0, i1, i2);
  strip = (Object__String)i0;
  i0 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 3072)))), Object__StringDesc_ToString8)),Object__StringDesc_ToString8)((Object__String)i0, 63u);
  ...
  IntStr__StrToInt((void*)(_check_pointer(i0, 3153)), i2, (void*)(OOC_INT64)&_int, (void*)(OOC_INT64)&res);
  i0 = res;
  switch (i0) {
  case 0:
    i0 = (OOC_INT64)v;
  ...
  case 2:
    i0 = (OOC_INT64)RT0__NewObject(_td_Exception__ParseError.baseTypes[0]);
    Exception__ParseErrorDesc_INIT((Exception__ParseError)i0, (Object__String)((OOC_INT64)_c5), i1);
    Exception__Raise((void*)i0);
    goto l41;
  case 1:
    i0 = (OOC_INT64)RT0__NewObject(_td_Exception__ParseError.baseTypes[0]);
...
Object__String Config__IntegerVarDesc_ToString(Config__IntegerVar v) {
  ...
  i0 = (OOC_INT64)Object__NewLatin1((void*)(OOC_INT64)str, 16);
...
Config__IntegerVar Config__IntegerVarDesc_Clone(Config__IntegerVar v) {
  ...
  i3 = (OOC_INT64)&_td_Config__IntegerVarDesc;
  i3 = i3!=i3;
  if (!i3) goto l4;
...
Config__StringVar Config__NewStringVar(Object__String8 str) {
  ...
  i0 = (OOC_INT64)RT0__NewObject(_td_Config__StringVar.baseTypes[0]);
  s = (Config__StringVar)i0;
  i1 = (OOC_INT64)str;
  *(OOC_INT64*)(_check_pointer(i0, 3955)) = i1;
...
void Config__StringVarDesc_StringToValue(Config__StringVar v, Object__String str) {
  ...
  i0 = (OOC_INT64)v;
  i1 = (OOC_INT64)str;
  *(OOC_INT64*)(_check_pointer(i0, 4073)) = i1;
  return;
  ;
}
...
Object__String Config__StringVarDesc_ToString(Config__StringVar v) {
  ...
  i0 = (OOC_INT64)v;
  i0 = (OOC_INT64)*(OOC_INT64*)(_check_pointer(i0, 4177));
  return (Object__String)i0;
  ;
}
...
Config__StringVar Config__StringVarDesc_Clone(Config__StringVar v) {
  ...
  i3 = (OOC_INT64)&_td_Config__StringVarDesc;
  i3 = i3!=i3;
  if (!i3) goto l4;
...
Config__Variable Config__GetClone(ADT_Dictionary__Dictionary map, Object__String prototypeName) {
  ...
  i0 = (OOC_INT64)prototypeName;
  i1 = (OOC_INT64)map;
  i0 = (OOC_INT64)ADT_Dictionary__DictionaryDesc_Get((ADT_Dictionary__Dictionary)i1, (Object__Object)i0);
  ptr = (Config__Variable)i0;
  i1 = i0==(OOC_INT64)0;
  if (i1) goto l3;
  i0 = (OOC_INT64)OOC_TBCALL(((OOC_INT64)OOC_TBPROC_ADR(((OOC_INT64)OOC_TYPE_TAG((_check_pointer(i0, 4698)))), Config__VariableDesc_Clone)),Config__VariableDesc_Clone)((Config__Variable)i0);
